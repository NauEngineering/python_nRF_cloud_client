...
PAGINATEDRESULTDEVICEORJSONATATRANSFORMEDRESPONSEITEMSINNER_ANY_OF_SCHEMAS = ["Device", "object"]

class PaginatedResultDeviceOrJSONataTransformedResponseItemsInner(BaseModel):
    """
    PaginatedResultDeviceOrJSONataTransformedResponseItemsInner
    """

    # data type: Device
    anyof_schema_1_validator: Optional[Device] = None
    # data type: object
    anyof_schema_2_validator: Optional[Any] = Field(default=None, description="Response body transformed by JSONata expression. For more info see https://docs.nordicsemi.com/bundle/nrf-cloud/page/APIs/REST/Tutorials/Transforms.html.")
    if TYPE_CHECKING:
        actual_instance: Optional[Union[Device, object]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "Device", "object" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PaginatedResultDeviceOrJSONataTransformedResponseItemsInner.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PaginatedResultDeviceOrJSONataTransformedResponseItemsInner with anyOf schemas: Device, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PaginatedResultDeviceOrJSONataTransformedResponseItemsInner with anyOf schemas: Device, object. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Device, object]]:
