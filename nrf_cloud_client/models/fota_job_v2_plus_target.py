...
class FotaJobV2PlusTarget(BaseModel):
    """
    FotaJobV2PlusTarget
    """ # noqa: E501
    firmware_versions: Optional[List[StrictStr]] = Field(default=None, alias="firmwareVersions")
    firmware_type: Optional[FirmwareTypes] = Field(default=None, alias="firmwareType")
    tags: List[StrictStr]
    device_ids: List[Annotated[str, Field(strict=True)]] = Field(alias="deviceIds")
    __properties: ClassVar[List[str]] = ["firmwareVersions", "firmwareType", "tags", "deviceIds"]
