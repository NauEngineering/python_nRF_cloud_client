...
class PickRecordLocationServicesLocationServiceUsageExcludeKeyofRecordLocationServicesLocationServiceUsageGROUNDFIX(BaseModel):
    """
    From T, pick a set of properties whose keys are in the union K
    """ # noqa: E501
    agps: Optional[LocationServiceUsage] = Field(default=None, alias="AGPS")
    pgps: Optional[LocationServiceUsage] = Field(default=None, alias="PGPS")
    scell: Optional[LocationServiceUsage] = Field(default=None, alias="SCELL")
    mcell: Optional[LocationServiceUsage] = Field(default=None, alias="MCELL")
    wifi: Optional[LocationServiceUsage] = Field(default=None, alias="WIFI")
    reverse_geo: Optional[LocationServiceUsage] = Field(default=None, alias="REVERSE_GEO")
    __properties: ClassVar[List[str]] = ["AGPS", "PGPS", "SCELL", "MCELL", "WIFI", "REVERSE_GEO"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of agps
        if self.agps:
            _dict['AGPS'] = self.agps.to_dict()
        # override the default output from pydantic by calling `to_dict()` of pgps
        if self.pgps:
            _dict['PGPS'] = self.pgps.to_dict()
        # override the default output from pydantic by calling `to_dict()` of scell
        if self.scell:
            _dict['SCELL'] = self.scell.to_dict()
        # override the default output from pydantic by calling `to_dict()` of mcell
        if self.mcell:
            _dict['MCELL'] = self.mcell.to_dict()
        # override the default output from pydantic by calling `to_dict()` of wifi
        if self.wifi:
            _dict['WIFI'] = self.wifi.to_dict()
        # override the default output from pydantic by calling `to_dict()` of reverse_geo
        if self.reverse_geo:
            _dict['REVERSE_GEO'] = self.reverse_geo.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AGPS": LocationServiceUsage.from_dict(obj["AGPS"]) if obj.get("AGPS") is not None else None,
            "PGPS": LocationServiceUsage.from_dict(obj["PGPS"]) if obj.get("PGPS") is not None else None,
            "SCELL": LocationServiceUsage.from_dict(obj["SCELL"]) if obj.get("SCELL") is not None else None,
            "MCELL": LocationServiceUsage.from_dict(obj["MCELL"]) if obj.get("MCELL") is not None else None,
            "WIFI": LocationServiceUsage.from_dict(obj["WIFI"]) if obj.get("WIFI") is not None else None,
            "REVERSE_GEO": LocationServiceUsage.from_dict(obj["REVERSE_GEO"]) if obj.get("REVERSE_GEO") is not None else None
        })
        return _obj
