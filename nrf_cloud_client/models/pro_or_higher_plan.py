...
class ProOrHigherPlan(BaseModel):
    """
    ProOrHigherPlan
    """ # noqa: E501
    ...
    name: PickPlanTypesExcludeKeyofPlanTypesDEVELOPER
    ...
    __properties: ClassVar[List[str]] = ["currentMonthCosts", "currentMonthTotalCost", "name", "proxyUsageDeclarations", "serviceKeys"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": PickPlanTypesExcludeKeyofPlanTypesDEVELOPER.from_dict(obj["name"]) if obj.get("name") is not None else None,
