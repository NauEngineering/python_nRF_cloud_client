...
PAGINATEDRESULTFOTAV2JOBORFOTAJOBV2PLUSITEMSINNER_ANY_OF_SCHEMAS = ["FOTAV2Job", "FotaJobV2Plus"]

class PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner(BaseModel):
    """
    PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner
    """

    # data type: FOTAV2Job
    anyof_schema_1_validator: Optional[FOTAV2Job] = None
    # data type: FotaJobV2Plus
    anyof_schema_2_validator: Optional[FotaJobV2Plus] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[FOTAV2Job, FotaJobV2Plus]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "FOTAV2Job", "FotaJobV2Plus" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner.model_construct()
        error_messages = []
        # validate data type: FOTAV2Job
        if not isinstance(v, FOTAV2Job):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FOTAV2Job`")
        else:
            return v

        # validate data type: FotaJobV2Plus
        if not isinstance(v, FotaJobV2Plus):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FotaJobV2Plus`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner with anyOf schemas: FOTAV2Job, FotaJobV2Plus. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[FOTAV2Job] = None
        try:
            instance.actual_instance = FOTAV2Job.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[FotaJobV2Plus] = None
        try:
            instance.actual_instance = FotaJobV2Plus.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner with anyOf schemas: FOTAV2Job, FotaJobV2Plus. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FOTAV2Job, FotaJobV2Plus]]:
