...
GROUNDFIXSERVICETYPE_ANY_OF_SCHEMAS = ["LocationServiceTypeMCELL", "LocationServiceTypeMCELLEVAL", "LocationServiceTypeSCELL", "LocationServiceTypeSCELLEVAL", "LocationServiceTypeWIFI", "LocationServiceTypeWIFIEVAL"]

class GroundFixServiceType(BaseModel):
    """
    GroundFixServiceType
    """

    # data type: LocationServiceTypeMCELL
    anyof_schema_1_validator: Optional[LocationServiceTypeMCELL] = None
    # data type: LocationServiceTypeSCELL
    anyof_schema_2_validator: Optional[LocationServiceTypeSCELL] = None
    # data type: LocationServiceTypeWIFI
    anyof_schema_3_validator: Optional[LocationServiceTypeWIFI] = None
    # data type: LocationServiceTypeMCELLEVAL
    anyof_schema_4_validator: Optional[LocationServiceTypeMCELLEVAL] = None
    # data type: LocationServiceTypeSCELLEVAL
    anyof_schema_5_validator: Optional[LocationServiceTypeSCELLEVAL] = None
    # data type: LocationServiceTypeWIFIEVAL
    anyof_schema_6_validator: Optional[LocationServiceTypeWIFIEVAL] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL, LocationServiceTypeWIFI, LocationServiceTypeWIFIEVAL]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LocationServiceTypeMCELL", "LocationServiceTypeMCELLEVAL", "LocationServiceTypeSCELL", "LocationServiceTypeSCELLEVAL", "LocationServiceTypeWIFI", "LocationServiceTypeWIFIEVAL" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GroundFixServiceType.model_construct()
        error_messages = []
        # validate data type: LocationServiceTypeMCELL
        if not isinstance(v, LocationServiceTypeMCELL):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeMCELL`")
        else:
            return v

        # validate data type: LocationServiceTypeSCELL
        if not isinstance(v, LocationServiceTypeSCELL):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeSCELL`")
        else:
            return v

        # validate data type: LocationServiceTypeWIFI
        if not isinstance(v, LocationServiceTypeWIFI):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeWIFI`")
        else:
            return v

        # validate data type: LocationServiceTypeMCELLEVAL
        if not isinstance(v, LocationServiceTypeMCELLEVAL):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeMCELLEVAL`")
        else:
            return v

        # validate data type: LocationServiceTypeSCELLEVAL
        if not isinstance(v, LocationServiceTypeSCELLEVAL):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeSCELLEVAL`")
        else:
            return v

        # validate data type: LocationServiceTypeWIFIEVAL
        if not isinstance(v, LocationServiceTypeWIFIEVAL):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceTypeWIFIEVAL`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GroundFixServiceType with anyOf schemas: LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL, LocationServiceTypeWIFI, LocationServiceTypeWIFIEVAL. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[LocationServiceTypeMCELL] = None
        try:
            instance.actual_instance = LocationServiceTypeMCELL.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[LocationServiceTypeSCELL] = None
        try:
            instance.actual_instance = LocationServiceTypeSCELL.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[LocationServiceTypeWIFI] = None
        try:
            instance.actual_instance = LocationServiceTypeWIFI.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[LocationServiceTypeMCELLEVAL] = None
        try:
            instance.actual_instance = LocationServiceTypeMCELLEVAL.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[LocationServiceTypeSCELLEVAL] = None
        try:
            instance.actual_instance = LocationServiceTypeSCELLEVAL.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_6_validator: Optional[LocationServiceTypeWIFIEVAL] = None
        try:
            instance.actual_instance = LocationServiceTypeWIFIEVAL.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GroundFixServiceType with anyOf schemas: LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL, LocationServiceTypeWIFI, LocationServiceTypeWIFIEVAL. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL, LocationServiceTypeWIFI, LocationServiceTypeWIFIEVAL]]:
