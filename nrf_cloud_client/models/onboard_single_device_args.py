...
class OnboardSingleDeviceArgs(BaseModel):
    """
    OnboardSingleDeviceArgs
    """ # noqa: E501
    certificate: StrictStr
    sub_type: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="A custom string value to specify the type of thing (device) being provisioned on nRF Cloud.", alias="subType")
    tags: Optional[List[StrictStr]] = None
    supported_firmware_types: Optional[List[FirmwareTypes]] = Field(default=None, alias="supportedFirmwareTypes")
    __properties: ClassVar[List[str]] = ["certificate", "subType", "tags", "supportedFirmwareTypes"]

    @field_validator('sub_type')
    def sub_type_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value

        if not re.match(r"[a-zA-Z0-9_.,@\/:#-]{0,799}", value):
            raise ValueError(r"must validate the regular expression /[a-zA-Z0-9_.,@\/:#-]{0,799}/")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "supportedFirmwareTypes": obj.get("supportedFirmwareTypes")
        })
        return _obj
