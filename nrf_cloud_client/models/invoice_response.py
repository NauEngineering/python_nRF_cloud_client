...
class InvoiceResponse(BaseModel):
    ...
    url: StrictStr
    status: InvoiceStatusEvents
    status_updated_at: Optional[StrictStr] = Field(default=None, alias="statusUpdatedAt")
    currency_code: StrictStr = Field(alias="currencyCode")
    payment_id: Optional[StrictStr] = Field(default=None, alias="paymentId")
    amount_formatted: StrictStr = Field(alias="amountFormatted")
    __properties: ClassVar[List[str]] = ["invoiceId", "total", "url", "status", "statusUpdatedAt", "currencyCode", "paymentId", "amountFormatted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amountFormatted": obj.get("amountFormatted")
        })
        return _obj
