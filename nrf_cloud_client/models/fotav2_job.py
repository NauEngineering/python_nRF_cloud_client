...
class FOTAV2Job(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["jobId", "target", "description", "status", "statusDetail", "createdAt", "lastUpdatedAt", "completedAt", "name", "executionStats", "firmware"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobId": obj.get("jobId"),
            "target": FotaV2JobTargetModel.from_dict(obj["target"]) if obj.get("target") is not None else None,
