...
class FOTAV2JobFirmware(BaseModel):
    """
    FOTAV2JobFirmware
    """ # noqa: E501
    bundle_id: FOTAV2JobFirmwareBundleId = Field(alias="bundleId")
    host: StrictStr
    file_size: Union[StrictFloat, StrictInt] = Field(alias="fileSize")
    firmware_type: FirmwareTypes = Field(alias="firmwareType")
    version: StrictStr
    uris: List[StrictStr]
    __properties: ClassVar[List[str]] = ["bundleId", "host", "fileSize", "firmwareType", "version", "uris"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bundleId": FOTAV2JobFirmwareBundleId.from_dict(obj["bundleId"]) if obj.get("bundleId") is not None else None,
            "host": obj.get("host"),
