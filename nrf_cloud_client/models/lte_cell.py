...
class LteCell(BaseModel):
    """
    LTE cell information. Use the 'nmr' property to send neighbor cell measurements for increased accuracy.
    """ # noqa: E501
    rsrp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Reference Signal Received Power. Measured in dBm. See <a href=\"https://www.rfwireless-world.com/Terminology/LTE-RSRP-vs-RSRQ.html\" target=\"_blank\">this page</a> for more details. Range -157..-44")
    rsrq: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Reference Signal Received Quality. Measured in dB. See <a href=\"https://www.rfwireless-world.com/Terminology/LTE-RSRP-vs-RSRQ.html\" target=\"_blank\">this page</a> for more details. Range -34.5..3.5")
    mcc: StrictInt = Field(description="Mobile Country Code. As defined in <a href=\"https://www.itu.int/dms_pub/itu-t/opb/sp/T-SP-E.212B-2018-PDF-E.pdf\" target=\"_blank\">ITU-T E.212</a>.")
    mnc: Mnc
    ...
    tac: StrictInt = Field(description="Tracking Area Code (TAC). Identifies a group of LTE cells in a certain region (Tracking Area). See <a href=\"https://www.etsi.org/deliver/etsi_ts/123000_123099/123003/17.09.00_60/ts_123003v170900p.pdf\" target=\"_blank\">ETSI TS 123 003, section 19.4.2.3</a> for more details.")
    pci: Optional[StrictInt] = Field(default=None, description="Physical Cell Identity (PCI). Used in the physical layer of E-UTRA systems to identify a cell. Range: 0..503")
    earfcn: Optional[StrictInt] = Field(default=None, description="Evolved Absolute Radio Frequency Channel (E-ARFCN). Range: 0..262143. See <a href=\"https://www.etsi.org/deliver/etsi_ts/136100_136199/136106/17.00.00_60/ts_136106v170000p.pdf\" target=\"_blank\">ETSI TS 136 106, section 5.7.3</a> for more details.")
    adv: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The length of time a signal takes to reach the base station from a mobile phone (half of rtt=round trip time). The units are symbols (Ts) as specified in 3GPP TS 36.211 (LTE). The expected resolution for nRF Cloud API is 1 Ts. Range 0..20512.")
    nmr: Optional[List[LteNeighborMeasurement]] = None
    __properties: ClassVar[List[str]] = ["rsrp", "rsrq", "mcc", "mnc", "eci", "tac", "pci", "earfcn", "adv", "nmr"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of mnc
        if self.mnc:
            _dict['mnc'] = self.mnc.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in nmr (list)
        _items = []
        if self.nmr:
            for _item_nmr in self.nmr:
                if _item_nmr:
                    _items.append(_item_nmr.to_dict())
            _dict['nmr'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rsrq": obj.get("rsrq"),
            "mcc": obj.get("mcc"),
            "mnc": Mnc.from_dict(obj["mnc"]) if obj.get("mnc") is not None else None,
            "eci": obj.get("eci"),
            "tac": obj.get("tac"),
            "pci": obj.get("pci"),
            "earfcn": obj.get("earfcn"),
            "adv": obj.get("adv"),
            "nmr": [LteNeighborMeasurement.from_dict(_item) for _item in obj["nmr"]] if obj.get("nmr") is not None else None
        })
        return _obj
