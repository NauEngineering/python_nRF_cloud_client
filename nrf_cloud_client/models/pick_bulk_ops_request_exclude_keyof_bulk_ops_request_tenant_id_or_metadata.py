...
class PickBulkOpsRequestExcludeKeyofBulkOpsRequestTenantIdOrMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bulkOpsRequestId", "endpoint", "status", "requestedAt", "completedAt"]
