...
class GpsRequest(BaseModel):
    ...
    acc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Accuracy in (2D 1-sigma) in meters.")
    alt: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Altitude above WGS 84 ellipsoid in meters.")
    spd: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Horizontal speed in meters per second.")
    hdg: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Heading of movement in degrees.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["lat", "lon", "acc", "alt", "spd", "hdg"]
