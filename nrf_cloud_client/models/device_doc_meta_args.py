...
class DeviceDocMetaArgs(BaseModel):
    """
    DeviceDocMetaArgs
    """ # noqa: E501
    created_at: Optional[DeviceDocMetaArgsCreatedAt] = Field(default=None, alias="createdAt")
    updated_at: Optional[DeviceDocMetaArgsCreatedAt] = Field(default=None, alias="updatedAt")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createdAt": DeviceDocMetaArgsCreatedAt.from_dict(obj["createdAt"]) if obj.get("createdAt") is not None else None,
            "updatedAt": DeviceDocMetaArgsCreatedAt.from_dict(obj["updatedAt"]) if obj.get("updatedAt") is not None else None
        })
        return _obj
