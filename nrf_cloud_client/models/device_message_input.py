...
class DeviceMessageInput(BaseModel):
    """
    Device message input
    """ # noqa: E501
    topic: Optional[StrictStr] = Field(default=None, description="A string specifying an MQTT topic.")
    message: DeviceMessageInputMessage
    __properties: ClassVar[List[str]] = ["topic", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "topic": obj.get("topic"),
            "message": DeviceMessageInputMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
