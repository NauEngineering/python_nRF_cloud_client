...
class AltLocationResponse(BaseModel):
    """
    AltLocationResponse
    """ # noqa: E501
    ...
    fulfilled_with: GroundFixServiceType = Field(alias="fulfilledWith")
    __properties: ClassVar[List[str]] = ["lat", "lon", "uncertainty", "fulfilledWith"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfilledWith": GroundFixServiceType.from_dict(obj["fulfilledWith"]) if obj.get("fulfilledWith") is not None else None
        })
        return _obj
