...
class DeveloperPlan(BaseModel):
    ...
    name: ExtractPlanTypesDEVELOPER
    limits: ApiLimitsDocumentModel
    __properties: ClassVar[List[str]] = ["currentMonthCosts", "currentMonthTotalCost", "name", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "limits": ApiLimitsDocumentModel.from_dict(obj["limits"]) if obj.get("limits") is not None else None
        })
        return _obj
