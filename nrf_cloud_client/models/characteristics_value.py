...
class CharacteristicsValue(BaseModel):
    """
    CharacteristicsValue
    """ # noqa: E501
    descriptors: Dict[str, DescriptorsValue]
    properties: CharacteristicsValueProperties
    value: List[Union[StrictFloat, StrictInt]]
    handle: Optional[Union[StrictFloat, StrictInt]] = None
    path: StrictStr
    uuid: StrictStr
    __properties: ClassVar[List[str]] = ["descriptors", "properties", "value", "handle", "path", "uuid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in descriptors (dict)
        _field_dict = {}
        if self.descriptors:
            for _key_descriptors in self.descriptors:
                if self.descriptors[_key_descriptors]:
                    _field_dict[_key_descriptors] = self.descriptors[_key_descriptors].to_dict()
            _dict['descriptors'] = _field_dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "descriptors": dict(
                (_k, DescriptorsValue.from_dict(_v))
                for _k, _v in obj["descriptors"].items()
            )
            if obj.get("descriptors") is not None
            else None,
            "properties": CharacteristicsValueProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "value": obj.get("value"),
