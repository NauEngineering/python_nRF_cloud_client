...
class GenericDevice(BaseModel):
    ...
    sub_type: GenericDeviceSubType = Field(alias="subType")
    ...
    type: DeviceTypesGeneric
    state: Optional[GenericDeviceState] = None
    __properties: ClassVar[List[str]] = ["id", "name", "image", "tags", "tenantId", "subType", "firmware", "$meta", "cloudMqttEnabled", "type", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subType": GenericDeviceSubType.from_dict(obj["subType"]) if obj.get("subType") is not None else None,
            ...
            "type": obj.get("type"),
            "state": GenericDeviceState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
