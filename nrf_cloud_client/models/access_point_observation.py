...
ACCESSPOINTOBSERVATION_ANY_OF_SCHEMAS = ["AccessPointWithChannelObservation", "AccessPointWithFrequencyObservation"]
...
class AccessPointObservation(BaseModel):
    ...
    # data type: AccessPointWithChannelObservation
    anyof_schema_1_validator: Optional[AccessPointWithChannelObservation] = None
    # data type: AccessPointWithFrequencyObservation
    anyof_schema_2_validator: Optional[AccessPointWithFrequencyObservation] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AccessPointWithChannelObservation, AccessPointWithFrequencyObservation]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AccessPointWithChannelObservation", "AccessPointWithFrequencyObservation" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AccessPointObservation.model_construct()
        error_messages = []
        # validate data type: AccessPointWithChannelObservation
        if not isinstance(v, AccessPointWithChannelObservation):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AccessPointWithChannelObservation`")
        else:
            return v

        # validate data type: AccessPointWithFrequencyObservation
        if not isinstance(v, AccessPointWithFrequencyObservation):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AccessPointWithFrequencyObservation`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AccessPointObservation with anyOf schemas: AccessPointWithChannelObservation, AccessPointWithFrequencyObservation. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[AccessPointWithChannelObservation] = None
        try:
            instance.actual_instance = AccessPointWithChannelObservation.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[AccessPointWithFrequencyObservation] = None
        try:
            instance.actual_instance = AccessPointWithFrequencyObservation.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AccessPointObservation with anyOf schemas: AccessPointWithChannelObservation, AccessPointWithFrequencyObservation. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AccessPointWithChannelObservation, AccessPointWithFrequencyObservation]]:
