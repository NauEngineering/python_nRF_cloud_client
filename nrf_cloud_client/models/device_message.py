...
class DeviceMessage(BaseModel):
    ...
    topic: StrictStr = Field(description="A string specifying an MQTT topic.")
    ...
    message: Dict[str, Any] = Field(description="Construct a type with a set of properties K of type T")
    __properties: ClassVar[List[str]] = ["tenantId", "topic", "deviceId", "receivedAt", "message"]
