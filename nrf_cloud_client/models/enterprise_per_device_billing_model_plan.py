...
class EnterprisePerDeviceBillingModelPlan(BaseModel):
    """
    EnterprisePerDeviceBillingModelPlan
    """ # noqa: E501
    current_month_costs: Optional[List[PickInvoiceLineItemNonOverageExcludeKeyofInvoiceLineItemNonOverageType]] = Field(default=None, alias="currentMonthCosts")
    current_month_total_cost: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="currentMonthTotalCost")
    name: ExtractPlanTypesENTERPRISE
    proxy_usage_declarations: ProxyUsageDeclarations = Field(alias="proxyUsageDeclarations")
    service_keys: Optional[List[ServiceKeyInfo]] = Field(default=None, alias="serviceKeys")
    overages: Overages
    __properties: ClassVar[List[str]] = ["currentMonthCosts", "currentMonthTotalCost", "name", "proxyUsageDeclarations", "serviceKeys", "overages"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in current_month_costs (list)
        _items = []
        if self.current_month_costs:
            for _item_current_month_costs in self.current_month_costs:
                if _item_current_month_costs:
                    _items.append(_item_current_month_costs.to_dict())
            _dict['currentMonthCosts'] = _items
        # override the default output from pydantic by calling `to_dict()` of proxy_usage_declarations
        if self.proxy_usage_declarations:
            _dict['proxyUsageDeclarations'] = self.proxy_usage_declarations.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in service_keys (list)
        _items = []
        if self.service_keys:
            for _item_service_keys in self.service_keys:
                if _item_service_keys:
                    _items.append(_item_service_keys.to_dict())
            _dict['serviceKeys'] = _items
        # override the default output from pydantic by calling `to_dict()` of overages
        if self.overages:
            _dict['overages'] = self.overages.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentMonthCosts": [PickInvoiceLineItemNonOverageExcludeKeyofInvoiceLineItemNonOverageType.from_dict(_item) for _item in obj["currentMonthCosts"]] if obj.get("currentMonthCosts") is not None else None,
            "currentMonthTotalCost": obj.get("currentMonthTotalCost"),
            "name": obj.get("name"),
            "proxyUsageDeclarations": ProxyUsageDeclarations.from_dict(obj["proxyUsageDeclarations"]) if obj.get("proxyUsageDeclarations") is not None else None,
            "serviceKeys": [ServiceKeyInfo.from_dict(_item) for _item in obj["serviceKeys"]] if obj.get("serviceKeys") is not None else None,
            "overages": Overages.from_dict(obj["overages"]) if obj.get("overages") is not None else None
        })
        return _obj
