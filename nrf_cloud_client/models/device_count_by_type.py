...
class DeviceCountByType(BaseModel):
    """
    DeviceCountByType
    """ # noqa: E501
    generic: Union[StrictFloat, StrictInt]
    gateway: Union[StrictFloat, StrictInt]
    bluetooth_le: Union[StrictFloat, StrictInt] = Field(alias="bluetoothLE")
    total: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["generic", "gateway", "bluetoothLE", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bluetoothLE": obj.get("bluetoothLE"),
            "total": obj.get("total")
        })
        return _obj
