...
class ObservingDevice(BaseModel):
    """
    ObservingDevice
    """ # noqa: E501
    manufacturer: Optional[StrictStr] = None
    firmware_version: Optional[StrictStr] = Field(default=None, alias="firmwareVersion")
    modem_version: Optional[StrictStr] = Field(default=None, alias="modemVersion")
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["manufacturer", "firmwareVersion", "modemVersion", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modemVersion": obj.get("modemVersion"),
            "id": obj.get("id")
        })
        return _obj
