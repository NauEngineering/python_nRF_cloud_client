...
DOREPLYFLAG_ANY_OF_SCHEMAS = ["bool", "float"]

class DoReplyFlag(BaseModel):
    """
    ...
    any_of_schemas: Set[str] = { "bool", "float" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = DoReplyFlag.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in DoReplyFlag with anyOf schemas: bool, float. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DoReplyFlag with anyOf schemas: bool, float. Details: " + ", ".join(error_messages))
        else:
            return instance
