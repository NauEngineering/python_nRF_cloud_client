...
class CreateJobInputTagsAndDeviceIds(BaseModel):
    """
    ...
    tags: Annotated[List[StrictStr], Field(min_length=1, max_length=100)] = Field(description="A list of tags to apply the device to")
    device_ids: Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=100)] = Field(description="A list of device identifiers assigned to this job.", alias="deviceIds")
    device_identifiers: Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1, max_length=100)] = Field(description="A list of device identifiers assigned to this job.", alias="deviceIdentifiers")
    __properties: ClassVar[List[str]] = ["bundleId", "autoApply", "name", "description", "tags", "deviceIds", "deviceIdentifiers"]
