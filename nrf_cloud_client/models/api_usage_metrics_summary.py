...
class ApiUsageMetricsSummary(BaseModel):
    """
    ApiUsageMetricsSummary
    """ # noqa: E501
    current_devices: DeviceCountByType = Field(alias="currentDevices")
    services: List[ServiceUsageSummary]
    __properties: ClassVar[List[str]] = ["currentDevices", "services"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of current_devices
        if self.current_devices:
            _dict['currentDevices'] = self.current_devices.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentDevices": DeviceCountByType.from_dict(obj["currentDevices"]) if obj.get("currentDevices") is not None else None,
            "services": [ServiceUsageSummary.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
