...
class CharacteristicsValueProperties(BaseModel):
    """
    CharacteristicsValueProperties
    """ # noqa: E501
    broadcast: Optional[StrictBool] = None
    authorized_signed_write: Optional[StrictBool] = Field(default=None, alias="authorizedSignedWrite")
    indicate: Optional[StrictBool] = None
    notify: Optional[StrictBool] = None
    write: Optional[StrictBool] = None
    write_without_response: Optional[StrictBool] = Field(default=None, alias="writeWithoutResponse")
    read: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["broadcast", "authorizedSignedWrite", "indicate", "notify", "write", "writeWithoutResponse", "read"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorizedSignedWrite": obj.get("authorizedSignedWrite"),
            "indicate": obj.get("indicate"),
            "notify": obj.get("notify"),
            "write": obj.get("write"),
            "writeWithoutResponse": obj.get("writeWithoutResponse"),
            "read": obj.get("read")
        })
        return _obj
