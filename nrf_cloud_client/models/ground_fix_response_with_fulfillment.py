...
class GroundFixResponseWithFulfillment(BaseModel):
    """
    GroundFixResponseWithFulfillment
    """ # noqa: E501
    lat: Union[StrictFloat, StrictInt] = Field(description="WGS 84 geodetic grid line, north to south.")
    lon: Union[StrictFloat, StrictInt] = Field(description="WGS 84 geodetic grid line, east to west.")
    uncertainty: StrictInt = Field(description="Radius of the uncertainty circle around the location in meters. Also known as Horizontal Positioning Error (HPE).")
    anchors: Optional[List[AnchorMeta]] = None
    fulfilled_with: GroundFixResponseWithFulfillmentFulfilledWith = Field(alias="fulfilledWith")
    alt: Optional[AlternateLocation] = None
    __properties: ClassVar[List[str]] = ["lat", "lon", "uncertainty", "anchors", "fulfilledWith", "alt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fulfilled_with
        if self.fulfilled_with:
            _dict['fulfilledWith'] = self.fulfilled_with.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfilledWith": GroundFixResponseWithFulfillmentFulfilledWith.from_dict(obj["fulfilledWith"]) if obj.get("fulfilledWith") is not None else None,
            "alt": AlternateLocation.from_dict(obj["alt"]) if obj.get("alt") is not None else None
        })
        return _obj
