...
RECORDGNSSCOORDINATESREQUEST_ANY_OF_SCHEMAS = ["GpsRequest", "str"]

class RecordGnssCoordinatesRequest(BaseModel):
    """
    RecordGnssCoordinatesRequest
    """

    # data type: GpsRequest
    anyof_schema_1_validator: Optional[GpsRequest] = None
    # data type: str
    anyof_schema_2_validator: Optional[StrictStr] = Field(default=None, description="NMEA 0183 GNSS sentence. See <a href=\"https://www.nmea.org/nmea-0183.html\" target=\"_blank\">this page</a> for more details.")
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GpsRequest, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "GpsRequest", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = RecordGnssCoordinatesRequest.model_construct()
        error_messages = []
        # validate data type: GpsRequest
        if not isinstance(v, GpsRequest):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GpsRequest`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in RecordGnssCoordinatesRequest with anyOf schemas: GpsRequest, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[GpsRequest] = None
        try:
            instance.actual_instance = GpsRequest.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into RecordGnssCoordinatesRequest with anyOf schemas: GpsRequest, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GpsRequest, str]]:
