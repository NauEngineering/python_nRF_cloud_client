...
class Contribution(BaseModel):
    ...
    Contribution
    """ # noqa: E501
    cell: Optional[List[CellObservation]] = None
    wifi: Optional[List[AccessPointObservation]] = None
    __properties: ClassVar[List[str]] = ["cell", "wifi"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in cell (list)
        _items = []
        if self.cell:
            for _item_cell in self.cell:
                if _item_cell:
                    _items.append(_item_cell.to_dict())
            _dict['cell'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cell": [CellObservation.from_dict(_item) for _item in obj["cell"]] if obj.get("cell") is not None else None,
            "wifi": [AccessPointObservation.from_dict(_item) for _item in obj["wifi"]] if obj.get("wifi") is not None else None
        })
        return _obj
