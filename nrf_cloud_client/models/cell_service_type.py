...
CELLSERVICETYPE_ANY_OF_SCHEMAS = ["LocationServiceTypeMCELL", "LocationServiceTypeMCELLEVAL", "LocationServiceTypeSCELL", "LocationServiceTypeSCELLEVAL"]

class CellServiceType(BaseModel):
    """
    CellServiceType
    """
    ...
    anyof_schema_3_validator: Optional[LocationServiceTypeMCELLEVAL] = None
    # data type: LocationServiceTypeSCELLEVAL
    anyof_schema_4_validator: Optional[LocationServiceTypeSCELLEVAL] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "LocationServiceTypeMCELL", "LocationServiceTypeMCELLEVAL", "LocationServiceTypeSCELL", "LocationServiceTypeSCELLEVAL" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CellServiceType.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CellServiceType with anyOf schemas: LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CellServiceType with anyOf schemas: LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], LocationServiceTypeMCELL, LocationServiceTypeMCELLEVAL, LocationServiceTypeSCELL, LocationServiceTypeSCELLEVAL]]:
