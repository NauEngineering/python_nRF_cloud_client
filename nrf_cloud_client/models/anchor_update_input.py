...
class AnchorUpdateInput(BaseModel):
    ...
    AnchorUpdateInput
    """ # noqa: E501
    lat: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="WGS 84 geodetic grid line, north to south.")
    lon: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="WGS 84 geodetic grid line, east to west.")
    ...
    __properties: ClassVar[List[str]] = ["lat", "lon", "name"]
