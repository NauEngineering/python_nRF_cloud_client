...
class ContributionItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "contributions", "device", "position", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "contributions": [Contribution.from_dict(_item) for _item in obj["contributions"]] if obj.get("contributions") is not None else None,
            "device": ObservingDevice.from_dict(obj["device"]) if obj.get("device") is not None else None,
