...
class AccountInfoArgs(BaseModel):
    """
    Describes general info for this user in this team
    """ # noqa: E501
    mqtt_endpoint: StrictStr = Field(description="The MQTT endpoint to connect to", alias="mqttEndpoint")
    mqtt_topic_prefix: StrictStr = Field(description="The global prefix for all topics", alias="mqttTopicPrefix")
    team: AccountInfoArgsTeam
    role: TenantUserRole
    user_id: Annotated[str, Field(strict=True)] = Field(description="Universally unique identifier", alias="userId")
    tags: Optional[List[StrictStr]] = Field(default=None, description="Your assigned list of device tags (device groups in the nrfcloud.com UI). You can access devices that have any of these tags assigned, and devices that have no tags assigned.")
    plan: AccountInfoArgsPlan
    __properties: ClassVar[List[str]] = ["mqttEndpoint", "mqttTopicPrefix", "team", "role", "userId", "tags", "plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mqttEndpoint": obj.get("mqttEndpoint"),
            "mqttTopicPrefix": obj.get("mqttTopicPrefix"),
            "team": AccountInfoArgsTeam.from_dict(obj["team"]) if obj.get("team") is not None else None,
            "role": obj.get("role"),
            "userId": obj.get("userId"),
            "tags": obj.get("tags"),
            "plan": AccountInfoArgsPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
