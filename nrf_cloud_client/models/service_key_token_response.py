...
class ServiceKeyTokenResponse(BaseModel):
    """
    ServiceKeyTokenResponse
    """ # noqa: E501
    expires: datetime = Field(description="Expiration date for the provided Service Evaluation Token")
    token: StrictStr = Field(description="JWT signed by the private key of the service key pair.")
    __properties: ClassVar[List[str]] = ["expires", "token"]
