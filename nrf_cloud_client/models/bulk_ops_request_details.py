...
class BulkOpsRequestDetails(BaseModel):
    """
    BulkOpsRequestDetails
    """ # noqa: E501
    bulk_ops_request_id: Annotated[str, Field(strict=True)] = Field(description="Universally Unique Lexicographically Sortable Identifier (using Crockford's alphabet).", alias="bulkOpsRequestId")
    endpoint: BulkOpsRequestEndpoint
    status: BulkOpsRequestStatus
    requested_at: datetime = Field(description="HTML-encoded ISO-8601 date-time string denoting the start or end of a date range. If the string includes only a date, the time is the beginning of the day (00:00:00).", alias="requestedAt")
    completed_at: Optional[datetime] = Field(default=None, description="HTML-encoded ISO-8601 date-time string denoting the start or end of a date range. If the string includes only a date, the time is the beginning of the day (00:00:00).", alias="completedAt")
    uploaded_data_url: StrictStr = Field(description="The URL at which you can retrieve the data you originally uploaded to an endpoint that supports bulk operations.", alias="uploadedDataUrl")
    result_data_url: Optional[StrictStr] = Field(default=None, description="The URL at which you can retrieve the result, if available, for the data you originally uploaded to an endpoint that supports bulk operations.", alias="resultDataUrl")
    error_summary_url: Optional[StrictStr] = Field(default=None, description="The URL at which you can retrieve a summary of errors and the row indices they occurred at for a failed bulk ops request job.", alias="errorSummaryUrl")
    __properties: ClassVar[List[str]] = ["bulkOpsRequestId", "endpoint", "status", "requestedAt", "completedAt", "uploadedDataUrl", "resultDataUrl", "errorSummaryUrl"]

    @field_validator('bulk_ops_request_id')
    def bulk_ops_request_id_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bulkOpsRequestId": obj.get("bulkOpsRequestId"),
            "endpoint": obj.get("endpoint"),
            "status": obj.get("status"),
            "requestedAt": obj.get("requestedAt"),
            "completedAt": obj.get("completedAt"),
            "uploadedDataUrl": obj.get("uploadedDataUrl"),
            "resultDataUrl": obj.get("resultDataUrl"),
            "errorSummaryUrl": obj.get("errorSummaryUrl")
        })
        return _obj
