...
class PickApiUsageMetricRecordExcludeKeyofApiUsageMetricRecordTenantId(BaseModel):
    """
    From T, pick a set of properties whose keys are in the union K
    """ # noqa: E501
    var_date: Optional[UsageMetricDate] = Field(default=None, alias="date")
    service: Service
    service_type: Optional[ServiceTypeValue] = Field(default=None, alias="serviceType")
    source: Optional[MetricSource] = None
    sum: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["date", "service", "serviceType", "source", "sum"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": UsageMetricDate.from_dict(obj["date"]) if obj.get("date") is not None else None,
            "service": obj.get("service"),
            "serviceType": ServiceTypeValue.from_dict(obj["serviceType"]) if obj.get("serviceType") is not None else None,
