...
class DeprecatedGroundFixRequest(BaseModel):
    """
    DeprecatedGroundFixRequest
    """ # noqa: E501
    lte: Optional[List[LteCell]] = None
    wifi: Optional[WifiAccessPointsRequest] = None
    __properties: ClassVar[List[str]] = ["lte", "wifi"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "wifi": WifiAccessPointsRequest.from_dict(obj["wifi"]) if obj.get("wifi") is not None else None
        })
        return _obj
