...
class AssistanceRequest(BaseModel):
    ...
    AssistanceRequest
    """ # noqa: E501
    types: Optional[List[NrfMessageType]] = Field(default=None, description="Type of assistance data (see description above). Defaults to [1, 2, 3, 4, 6, 7, 9]")
    mcc: Optional[StrictInt] = Field(default=None, description="Mobile Country Code. As defined in <a href=\"https://www.itu.int/dms_pub/itu-t/opb/sp/T-SP-E.212B-2018-PDF-E.pdf\" target=\"_blank\">ITU-T E.212</a>.")
    mnc: Optional[Mnc] = None
    tac: Optional[StrictInt] = Field(default=None, description="Tracking Area Code (TAC). Identifies a group of LTE cells in a certain region (Tracking Area). See <a href=\"https://www.etsi.org/deliver/etsi_ts/123000_123099/123003/17.09.00_60/ts_123003v170900p.pdf\" target=\"_blank\">ETSI TS 123 003, section 19.4.2.3</a> for more details.")
    eci: Optional[StrictInt] = Field(default=None, description="E-UTRA Cell Identifier (ECI), 28 bits (20 bits eNodeB and 8 bits Cell ID). Calculated using \"(eNodeB-ID * 256) + Sector-ID\". Range 0 .. 268435455. See <a href=\"https://www.etsi.org/deliver/etsi_ts/123000_123099/123003/17.09.00_60/ts_123003v170900p.pdf\" target=\"_blank\">ETSI TS 123 003, section 19.6</a> for more details.")
    ...
    filtered: Optional[StrictBool] = Field(default=None, description="Send this flag if you want to receive ephemeris for only satellites in view. nRF Cloud will return ephemeris for up to 16 satellites. Cell data (eci, mcc, mnc, tac) is required. Defaults to false.")
    mask: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Filtered ephemeris mask angle. Only works in conjunction with the filtered flag. Controls the mask angle for which the satellites are filtered. Range 0..90 Defaults to 5")
    __properties: ClassVar[List[str]] = ["types", "mcc", "mnc", "tac", "eci", "rsrp", "filtered", "mask"]
