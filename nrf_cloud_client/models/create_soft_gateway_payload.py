...
class CreateSoftGatewayPayload(BaseModel):
    """
    CreateSoftGatewayPayload
    """ # noqa: E501
    cognito_identity_id: StrictStr = Field(alias="cognitoIdentityId")
    soft_gateway_type: Optional[SoftGatewayType] = Field(default=None, alias="softGatewayType")
    __properties: ClassVar[List[str]] = ["cognitoIdentityId", "softGatewayType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cognitoIdentityId": obj.get("cognitoIdentityId"),
            "softGatewayType": obj.get("softGatewayType")
        })
        return _obj
