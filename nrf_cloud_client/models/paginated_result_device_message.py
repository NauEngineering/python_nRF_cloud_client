...
class PaginatedResultDeviceMessage(BaseModel):
    """
    PaginatedResultDeviceMessage
    """ # noqa: E501
    items: List[DeviceMessage]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DeviceMessage.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
