...
class ArchivedAlert(BaseModel):
    ...
    status_changed_at: datetime = Field(description="HTML-encoded ISO-8601 date-time string denoting the start or end of a date range. If the string includes only a date, the time is the beginning of the day (00:00:00).", alias="statusChangedAt")
    status_changed_by: Annotated[str, Field(strict=True)] = Field(description="Universally unique identifier", alias="statusChangedBy")
    status: StrictStr
