...
DEVICEMESSAGEINPUTMESSAGE_ANY_OF_SCHEMAS = ["List[Message]", "Message", "str"]

class DeviceMessageInputMessage(BaseModel):
    """
    DeviceMessageInputMessage
    """

    # data type: Message
    anyof_schema_1_validator: Optional[Message] = None
    # data type: List[Message]
    anyof_schema_2_validator: Optional[List[Message]] = None
    # data type: str
    anyof_schema_3_validator: Optional[StrictStr] = Field(default=None, description="Binary data encoded as a base64 string. This is intended for binary dictionary based logging data. For more info [see here](https://docs.nordicsemi.com/bundle/ncs-latest/page/zephyr/services/logging/index.html#dictionary-based_logging).")
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[Message], Message, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[Message]", "Message", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = DeviceMessageInputMessage.model_construct()
        error_messages = []
        ...
        # validate data type: List[Message]
        try:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in DeviceMessageInputMessage with anyOf schemas: List[Message], Message, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            return instance
             ...
             error_messages.append(str(e))
        # deserialize data into List[Message]
        try:
            # validation
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DeviceMessageInputMessage with anyOf schemas: List[Message], Message, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[Message], Message, str]]:
