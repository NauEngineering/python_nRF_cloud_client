...
CREATEJOBINPUT_ANY_OF_SCHEMAS = ["CreateJobInputCriteria", "CreateJobInputIdOrIdentifier", "CreateJobInputTags", "CreateJobInputTagsAndDeviceIds"]
...
class CreateJobInput(BaseModel):
    ...
    # data type: CreateJobInputTags
    anyof_schema_1_validator: Optional[CreateJobInputTags] = None
    # data type: CreateJobInputTagsAndDeviceIds
    anyof_schema_2_validator: Optional[CreateJobInputTagsAndDeviceIds] = None
    # data type: CreateJobInputIdOrIdentifier
    anyof_schema_3_validator: Optional[CreateJobInputIdOrIdentifier] = None
    # data type: CreateJobInputCriteria
    anyof_schema_4_validator: Optional[CreateJobInputCriteria] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[CreateJobInputCriteria, CreateJobInputIdOrIdentifier, CreateJobInputTags, CreateJobInputTagsAndDeviceIds]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "CreateJobInputCriteria", "CreateJobInputIdOrIdentifier", "CreateJobInputTags", "CreateJobInputTagsAndDeviceIds" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CreateJobInput.model_construct()
        error_messages = []
        # validate data type: CreateJobInputTags
        if not isinstance(v, CreateJobInputTags):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CreateJobInputTags`")
        else:
            return v

        # validate data type: CreateJobInputTagsAndDeviceIds
        if not isinstance(v, CreateJobInputTagsAndDeviceIds):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CreateJobInputTagsAndDeviceIds`")
        else:
            return v

        # validate data type: CreateJobInputIdOrIdentifier
        if not isinstance(v, CreateJobInputIdOrIdentifier):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CreateJobInputIdOrIdentifier`")
        else:
            return v

        # validate data type: CreateJobInputCriteria
        if not isinstance(v, CreateJobInputCriteria):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CreateJobInputCriteria`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CreateJobInput with anyOf schemas: CreateJobInputCriteria, CreateJobInputIdOrIdentifier, CreateJobInputTags, CreateJobInputTagsAndDeviceIds. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[CreateJobInputTags] = None
        try:
            instance.actual_instance = CreateJobInputTags.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[CreateJobInputTagsAndDeviceIds] = None
        try:
            instance.actual_instance = CreateJobInputTagsAndDeviceIds.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[CreateJobInputIdOrIdentifier] = None
        try:
            instance.actual_instance = CreateJobInputIdOrIdentifier.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[CreateJobInputCriteria] = None
        try:
            instance.actual_instance = CreateJobInputCriteria.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CreateJobInput with anyOf schemas: CreateJobInputCriteria, CreateJobInputIdOrIdentifier, CreateJobInputTags, CreateJobInputTagsAndDeviceIds. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], CreateJobInputCriteria, CreateJobInputIdOrIdentifier, CreateJobInputTags, CreateJobInputTagsAndDeviceIds]]:
