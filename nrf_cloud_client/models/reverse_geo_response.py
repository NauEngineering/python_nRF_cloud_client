...
class ReverseGeoResponse(BaseModel):
    ...
    formatted: StrictStr = Field(description="Description of the address, created from values in the 'address' property")
    address: ReverseGeoAddress
    __properties: ClassVar[List[str]] = ["lat", "lon", "uncertainty", "formatted", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": ReverseGeoAddress.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
