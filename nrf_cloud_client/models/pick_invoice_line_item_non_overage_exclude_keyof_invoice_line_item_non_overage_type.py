...
class PickInvoiceLineItemNonOverageExcludeKeyofInvoiceLineItemNonOverageType(BaseModel):
    """
    From T, pick a set of properties whose keys are in the union K
    """ # noqa: E501
    service_id: PickInvoiceLineItemNonOverageExcludeKeyofInvoiceLineItemNonOverageTypeServiceId = Field(alias="serviceId")
    service_description: StrictStr = Field(alias="serviceDescription")
    quantity: Union[StrictFloat, StrictInt]
    price: Union[StrictFloat, StrictInt]
    total: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["serviceId", "serviceDescription", "quantity", "price", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceId": PickInvoiceLineItemNonOverageExcludeKeyofInvoiceLineItemNonOverageTypeServiceId.from_dict(obj["serviceId"]) if obj.get("serviceId") is not None else None,
