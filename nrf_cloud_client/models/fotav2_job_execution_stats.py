...
class FOTAV2JobExecutionStats(BaseModel):
    """
    FOTAV2JobExecutionStats
    """ # noqa: E501
    completed_executions: Union[StrictFloat, StrictInt] = Field(alias="completedExecutions")
    executions: Union[StrictFloat, StrictInt]
    devices: Union[StrictFloat, StrictInt]
    timed_out: Union[StrictFloat, StrictInt] = Field(alias="timedOut")
    removed: Union[StrictFloat, StrictInt]
    downloading: Union[StrictFloat, StrictInt]
    in_progress: Union[StrictFloat, StrictInt] = Field(alias="inProgress")
    queued: Union[StrictFloat, StrictInt]
    rejected: Union[StrictFloat, StrictInt]
    failed: Union[StrictFloat, StrictInt]
    succeeded: Union[StrictFloat, StrictInt]
    cancelled: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["completedExecutions", "executions", "devices", "timedOut", "removed", "downloading", "inProgress", "queued", "rejected", "failed", "succeeded", "cancelled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "completedExecutions": obj.get("completedExecutions"),
