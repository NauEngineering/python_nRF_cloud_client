...
class ServiceUsageSummary(BaseModel):
    ...
    fota_job_executions: Union[StrictFloat, StrictInt] = Field(alias="fotaJobExecutions")
    location_services: PickRecordLocationServicesLocationServiceUsageExcludeKeyofRecordLocationServicesLocationServiceUsageGROUNDFIX = Field(alias="locationServices")
    stored_device_messages: Union[StrictFloat, StrictInt] = Field(alias="storedDeviceMessages")
    messages_routed: Union[StrictFloat, StrictInt] = Field(alias="messagesRouted")
    __properties: ClassVar[List[str]] = ["date", "fotaJobExecutions", "locationServices", "storedDeviceMessages", "messagesRouted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "fotaJobExecutions": obj.get("fotaJobExecutions"),
            "locationServices": PickRecordLocationServicesLocationServiceUsageExcludeKeyofRecordLocationServicesLocationServiceUsageGROUNDFIX.from_dict(obj["locationServices"]) if obj.get("locationServices") is not None else None,
            "storedDeviceMessages": obj.get("storedDeviceMessages"),
            "messagesRouted": obj.get("messagesRouted")
        })
        return _obj
