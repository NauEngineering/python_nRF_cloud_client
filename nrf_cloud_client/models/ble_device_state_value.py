...
class BLEDeviceStateValue(BaseModel):
    """
    BLEDeviceStateValue
    """ # noqa: E501
    characteristics: Dict[str, CharacteristicsValue]
    uuid: StrictStr
    __properties: ClassVar[List[str]] = ["characteristics", "uuid"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in characteristics (dict)
        _field_dict = {}
        if self.characteristics:
            for _key_characteristics in self.characteristics:
                if self.characteristics[_key_characteristics]:
                    _field_dict[_key_characteristics] = self.characteristics[_key_characteristics].to_dict()
            _dict['characteristics'] = _field_dict
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "characteristics": dict(
                (_k, CharacteristicsValue.from_dict(_v))
                for _k, _v in obj["characteristics"].items()
            )
