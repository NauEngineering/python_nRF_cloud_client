...
class FOTAJobExecution(BaseModel):
    """
    FOTAJobExecution
    """ # noqa: E501
    ...
    job_document: FotaV2JobDocumentModel = Field(alias="jobDocument")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "status", "executionId", "jobId", "statusDetail", "jobDocument", "createdAt", "deviceId", "lastUpdatedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobDocument": FotaV2JobDocumentModel.from_dict(obj["jobDocument"]) if obj.get("jobDocument") is not None else None,
