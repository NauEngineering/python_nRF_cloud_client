...
class Anchor(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Limit 32 characters. Only numbers, letters, underscores, dashes, and spaces allowed. All other characters will be removed.")
    __properties: ClassVar[List[str]] = ["macAddress", "lat", "lon", "createdAt", "updatedAt", "name"]
