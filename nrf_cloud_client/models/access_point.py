...
ACCESSPOINT_ANY_OF_SCHEMAS = ["AccessPointWithChannel", "AccessPointWithFrequency"]
...
class AccessPoint(BaseModel):
    ...
    # data type: AccessPointWithFrequency
    anyof_schema_1_validator: Optional[AccessPointWithFrequency] = None
    # data type: AccessPointWithChannel
    anyof_schema_2_validator: Optional[AccessPointWithChannel] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AccessPointWithChannel, AccessPointWithFrequency]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AccessPointWithChannel", "AccessPointWithFrequency" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AccessPoint.model_construct()
        error_messages = []
        # validate data type: AccessPointWithFrequency
        if not isinstance(v, AccessPointWithFrequency):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AccessPointWithFrequency`")
        else:
            return v

        # validate data type: AccessPointWithChannel
        if not isinstance(v, AccessPointWithChannel):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AccessPointWithChannel`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AccessPoint with anyOf schemas: AccessPointWithChannel, AccessPointWithFrequency. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[AccessPointWithFrequency] = None
        try:
            instance.actual_instance = AccessPointWithFrequency.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[AccessPointWithChannel] = None
        try:
            instance.actual_instance = AccessPointWithChannel.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AccessPoint with anyOf schemas: AccessPointWithChannel, AccessPointWithFrequency. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AccessPointWithChannel, AccessPointWithFrequency]]:
