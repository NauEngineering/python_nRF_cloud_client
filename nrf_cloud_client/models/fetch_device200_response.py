...
FETCHDEVICE200RESPONSE_ANY_OF_SCHEMAS = ["BLEDevice", "GatewayDevice", "GenericDevice", "object"]

class FetchDevice200Response(BaseModel):
    """
    FetchDevice200Response
    """

    # data type: BLEDevice
    anyof_schema_1_validator: Optional[BLEDevice] = None
    # data type: GenericDevice
    anyof_schema_2_validator: Optional[GenericDevice] = None
    # data type: GatewayDevice
    anyof_schema_3_validator: Optional[GatewayDevice] = None
    # data type: object
    anyof_schema_4_validator: Optional[Any] = Field(default=None, description="Response body transformed by JSONata expression. For more info see https://docs.nordicsemi.com/bundle/nrf-cloud/page/APIs/REST/Tutorials/Transforms.html.")
    if TYPE_CHECKING:
        actual_instance: Optional[Union[BLEDevice, GatewayDevice, GenericDevice, object]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "BLEDevice", "GatewayDevice", "GenericDevice", "object" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FetchDevice200Response.model_construct()
        error_messages = []
        # validate data type: BLEDevice
        if not isinstance(v, BLEDevice):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BLEDevice`")
        else:
            return v
        ...
        # validate data type: GatewayDevice
        if not isinstance(v, GatewayDevice):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GatewayDevice`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FetchDevice200Response with anyOf schemas: BLEDevice, GatewayDevice, GenericDevice, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[BLEDevice] = None
        try:
            instance.actual_instance = BLEDevice.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[GenericDevice] = None
        ...
        # anyof_schema_3_validator: Optional[GatewayDevice] = None
        try:
            instance.actual_instance = GatewayDevice.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FetchDevice200Response with anyOf schemas: BLEDevice, GatewayDevice, GenericDevice, object. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BLEDevice, GatewayDevice, GenericDevice, object]]:
