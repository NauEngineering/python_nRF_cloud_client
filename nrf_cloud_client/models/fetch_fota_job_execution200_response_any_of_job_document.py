...
class FetchFOTAJobExecution200ResponseAnyOfJobDocument(BaseModel):
    """
    ...
    bundle_id: Any = Field(alias="bundleId")
    file_size: Optional[Any] = Field(alias="fileSize")
    firmware_type: Optional[Any] = Field(alias="firmwareType")
    __properties: ClassVar[List[str]] = ["path", "host", "version", "bundleId", "fileSize", "firmwareType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if firmware_type (nullable) is None
        # and model_fields_set contains the field
        if self.firmware_type is None and "firmware_type" in self.model_fields_set:
            _dict['firmwareType'] = None
