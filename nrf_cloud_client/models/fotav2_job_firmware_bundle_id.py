...
FOTAV2JOBFIRMWAREBUNDLEID_ANY_OF_SCHEMAS = ["str"]

class FOTAV2JobFirmwareBundleId(BaseModel):
    """
    FOTAV2JobFirmwareBundleId
    """

    # data type: str
    anyof_schema_1_validator: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique bundle identifier")
    # data type: str
    anyof_schema_2_validator: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Universally unique identifier")
    if TYPE_CHECKING:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FOTAV2JobFirmwareBundleId.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FOTAV2JobFirmwareBundleId with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FOTAV2JobFirmwareBundleId with anyOf schemas: str. Details: " + ", ".join(error_messages))
        else:
            return instance
