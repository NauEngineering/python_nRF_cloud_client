...
FETCHFOTAJOBEXECUTION200RESPONSE_ANY_OF_SCHEMAS = ["FOTAJobExecution", "FetchFOTAJobExecution200ResponseAnyOf"]

class FetchFOTAJobExecution200Response(BaseModel):
    """
    FetchFOTAJobExecution200Response
    """

    # data type: FOTAJobExecution
    anyof_schema_1_validator: Optional[FOTAJobExecution] = None
    # data type: FetchFOTAJobExecution200ResponseAnyOf
    anyof_schema_2_validator: Optional[FetchFOTAJobExecution200ResponseAnyOf] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[FOTAJobExecution, FetchFOTAJobExecution200ResponseAnyOf]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "FOTAJobExecution", "FetchFOTAJobExecution200ResponseAnyOf" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FetchFOTAJobExecution200Response.model_construct()
        error_messages = []
        # validate data type: FOTAJobExecution
        if not isinstance(v, FOTAJobExecution):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FOTAJobExecution`")
        else:
            return v

        # validate data type: FetchFOTAJobExecution200ResponseAnyOf
        if not isinstance(v, FetchFOTAJobExecution200ResponseAnyOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FetchFOTAJobExecution200ResponseAnyOf`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FetchFOTAJobExecution200Response with anyOf schemas: FOTAJobExecution, FetchFOTAJobExecution200ResponseAnyOf. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[FOTAJobExecution] = None
        try:
            instance.actual_instance = FOTAJobExecution.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[FetchFOTAJobExecution200ResponseAnyOf] = None
        try:
            instance.actual_instance = FetchFOTAJobExecution200ResponseAnyOf.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FetchFOTAJobExecution200Response with anyOf schemas: FOTAJobExecution, FetchFOTAJobExecution200ResponseAnyOf. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FOTAJobExecution, FetchFOTAJobExecution200ResponseAnyOf]]:
