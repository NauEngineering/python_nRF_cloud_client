...
class WifiAccessPointsRequest(BaseModel):
    """
    WifiAccessPointsRequest
    """ # noqa: E501
    access_points: List[AccessPoint] = Field(alias="accessPoints")
    __properties: ClassVar[List[str]] = ["accessPoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessPoints": [AccessPoint.from_dict(_item) for _item in obj["accessPoints"]] if obj.get("accessPoints") is not None else None
        })
        return _obj
