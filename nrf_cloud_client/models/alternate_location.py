...
class AlternateLocation(BaseModel):
    """
    AlternateLocation
    """ # noqa: E501
    loc: AltLocationResponse
    dist: Union[StrictFloat, StrictInt] = Field(description="Distance in meters between the alternate location and the main location.")
    __properties: ClassVar[List[str]] = ["loc", "dist"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "loc": AltLocationResponse.from_dict(obj["loc"]) if obj.get("loc") is not None else None,
            "dist": obj.get("dist")
        })
        return _obj
