...
COMMERCIALSERVICES_ANY_OF_SCHEMAS = ["GeocodeLocationServices", "LocationServices", "NonLocationServices"]

class CommercialServices(BaseModel):
    """
    CommercialServices
    """

    # data type: LocationServices
    anyof_schema_1_validator: Optional[LocationServices] = None
    # data type: NonLocationServices
    anyof_schema_2_validator: Optional[NonLocationServices] = None
    # data type: GeocodeLocationServices
    anyof_schema_3_validator: Optional[GeocodeLocationServices] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GeocodeLocationServices, LocationServices, NonLocationServices]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "GeocodeLocationServices", "LocationServices", "NonLocationServices" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CommercialServices.model_construct()
        error_messages = []
        # validate data type: LocationServices
        if not isinstance(v, LocationServices):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServices`")
        else:
            return v

        # validate data type: NonLocationServices
        if not isinstance(v, NonLocationServices):
            error_messages.append(f"Error! Input type `{type(v)}` is not `NonLocationServices`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CommercialServices with anyOf schemas: GeocodeLocationServices, LocationServices, NonLocationServices. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[LocationServices] = None
        try:
            instance.actual_instance = LocationServices.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[NonLocationServices] = None
        try:
            instance.actual_instance = NonLocationServices.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[GeocodeLocationServices] = None
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CommercialServices with anyOf schemas: GeocodeLocationServices, LocationServices, NonLocationServices. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GeocodeLocationServices, LocationServices, NonLocationServices]]:
