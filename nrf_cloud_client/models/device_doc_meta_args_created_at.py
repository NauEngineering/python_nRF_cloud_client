...
DEVICEDOCMETAARGSCREATEDAT_ANY_OF_SCHEMAS = ["datetime", "str"]

class DeviceDocMetaArgsCreatedAt(BaseModel):
    """
    DeviceDocMetaArgsCreatedAt
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = DeviceDocMetaArgsCreatedAt.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in DeviceDocMetaArgsCreatedAt with anyOf schemas: datetime, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DeviceDocMetaArgsCreatedAt with anyOf schemas: datetime, str. Details: " + ", ".join(error_messages))
        else:
            return instance
