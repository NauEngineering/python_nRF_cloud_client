...
class AccessPointWithFrequencyObservation(BaseModel):
    """
    AccessPointWithFrequencyObservation
    """ # noqa: E501
    mac_address: StrictStr = Field(description="String comprised of 6 hexadecimal pairs, separated by colons or dashes. When used in a positioning request, it must be universally assigned. See <a href=\"https://docs.nordicsemi.com/bundle/nrf-cloud/page/LocationServices/Guides/LocationTroubleshooting.html#my-wi-fi-request-returns-the-error-mac-address-mac-is-a-local-mac-address\" target=\"_blank\">this help page</a> for details.", alias="macAddress")
    ssid: Optional[StrictStr] = None
    signal_strength: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Signal strength in dBm, between -128 and 0", alias="signalStrength")
    age: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of milliseconds since this access point was detected.")
    signal_to_noise_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The current signal to noise ratio measured in dB.", alias="signalToNoiseRatio")
    frequency: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Channel frequency in MHz")
    observed_at: StrictStr = Field(description="ISO 8601 format. Example 2021-03-07T21:02:51.907Z", alias="observedAt")
    __properties: ClassVar[List[str]] = ["macAddress", "ssid", "signalStrength", "age", "signalToNoiseRatio", "frequency", "observedAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "age": obj.get("age"),
            "signalToNoiseRatio": obj.get("signalToNoiseRatio"),
