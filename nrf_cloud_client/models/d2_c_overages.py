...
class D2COverages(BaseModel):
    """
    D2COverages
    """ # noqa: E501
    agps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="AGPS")
    pgps: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="PGPS")
    scell: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="SCELL")
    mcell: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="MCELL")
    wifi: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="WIFI")
    reverse_geo: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="REVERSE_GEO")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["AGPS", "PGPS", "SCELL", "MCELL", "WIFI", "REVERSE_GEO", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['D2C']):
            raise ValueError("must be one of enum values ('D2C')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MCELL": obj.get("MCELL"),
            "WIFI": obj.get("WIFI"),
            "REVERSE_GEO": obj.get("REVERSE_GEO"),
            "type": obj.get("type")
        })
        return _obj
