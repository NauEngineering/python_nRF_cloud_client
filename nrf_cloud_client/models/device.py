...
DEVICE_ANY_OF_SCHEMAS = ["BLEDevice", "GatewayDevice", "GenericDevice"]
...
class Device(BaseModel):
    ...
    anyof_schema_1_validator: Optional[GenericDevice] = None
    # data type: BLEDevice
    anyof_schema_2_validator: Optional[BLEDevice] = None
    # data type: GatewayDevice
    anyof_schema_3_validator: Optional[GatewayDevice] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[BLEDevice, GatewayDevice, GenericDevice]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "BLEDevice", "GatewayDevice", "GenericDevice" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Device.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Device with anyOf schemas: BLEDevice, GatewayDevice, GenericDevice. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Device with anyOf schemas: BLEDevice, GatewayDevice, GenericDevice. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BLEDevice, GatewayDevice, GenericDevice]]:
