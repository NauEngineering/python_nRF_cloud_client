...
class CellResponseWithFulfillment(BaseModel):
    """
    ...
    fulfilled_with: CellServiceType = Field(alias="fulfilledWith")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfilledWith": CellServiceType.from_dict(obj["fulfilledWith"]) if obj.get("fulfilledWith") is not None else None
        })
        return _obj
