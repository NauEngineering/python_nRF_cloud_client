...
class ApiLimitsDocumentModel(BaseModel):
    """
    ApiLimitsDocumentModel
    """ # noqa: E501
    devices: Union[StrictFloat, StrictInt]
    monthly_fota_job_executions: Union[StrictFloat, StrictInt] = Field(alias="monthlyFOTAJobExecutions")
    monthly_stored_device_messages: Union[StrictFloat, StrictInt] = Field(alias="monthlyStoredDeviceMessages")
    monthly_location_service_requests: Union[StrictFloat, StrictInt] = Field(alias="monthlyLocationServiceRequests")
    message_routing_service_destinations: Union[StrictFloat, StrictInt] = Field(alias="messageRoutingServiceDestinations")
    __properties: ClassVar[List[str]] = ["devices", "monthlyFOTAJobExecutions", "monthlyStoredDeviceMessages", "monthlyLocationServiceRequests", "messageRoutingServiceDestinations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlyFOTAJobExecutions": obj.get("monthlyFOTAJobExecutions"),
            "monthlyStoredDeviceMessages": obj.get("monthlyStoredDeviceMessages"),
            "monthlyLocationServiceRequests": obj.get("monthlyLocationServiceRequests"),
            "messageRoutingServiceDestinations": obj.get("messageRoutingServiceDestinations")
        })
        return _obj
