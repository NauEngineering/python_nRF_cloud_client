...
LOCATIONSERVICES_ANY_OF_SCHEMAS = ["GPSLocationServices", "GeocodeLocationServices", "GroundFixLocationServices"]
...
class LocationServices(BaseModel):
    ...
    # data type: GPSLocationServices
    anyof_schema_1_validator: Optional[GPSLocationServices] = None
    # data type: GroundFixLocationServices
    anyof_schema_2_validator: Optional[GroundFixLocationServices] = None
    # data type: GeocodeLocationServices
    anyof_schema_3_validator: Optional[GeocodeLocationServices] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[GPSLocationServices, GeocodeLocationServices, GroundFixLocationServices]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "GPSLocationServices", "GeocodeLocationServices", "GroundFixLocationServices" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = LocationServices.model_construct()
        error_messages = []
        # validate data type: GPSLocationServices
        if not isinstance(v, GPSLocationServices):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GPSLocationServices`")
        else:
            return v

        # validate data type: GroundFixLocationServices
        if not isinstance(v, GroundFixLocationServices):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GroundFixLocationServices`")
        else:
            return v

        # validate data type: GeocodeLocationServices
        if not isinstance(v, GeocodeLocationServices):
            error_messages.append(f"Error! Input type `{type(v)}` is not `GeocodeLocationServices`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in LocationServices with anyOf schemas: GPSLocationServices, GeocodeLocationServices, GroundFixLocationServices. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[GPSLocationServices] = None
        try:
            instance.actual_instance = GPSLocationServices.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[GroundFixLocationServices] = None
        try:
            instance.actual_instance = GroundFixLocationServices.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[GeocodeLocationServices] = None
        try:
            instance.actual_instance = GeocodeLocationServices.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into LocationServices with anyOf schemas: GPSLocationServices, GeocodeLocationServices, GroundFixLocationServices. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GPSLocationServices, GeocodeLocationServices, GroundFixLocationServices]]:
