...
class DeviceCertificate(BaseModel):
    ...
    DeviceCertificate
    """ # noqa: E501
    client_id: Annotated[str, Field(strict=True)] = Field(description="This is the canonical device id used in the device certificate, and as the MQTT client id.", alias="clientId")
    ca_cert: StrictStr = Field(description="The AmazonRootCA1.pem used for establishing TLS communications with AWS IoT.", alias="caCert")
    client_cert: StrictStr = Field(description="The x.509 certificate. If this is for an \"mqtt team device\" this string contains only one certificate. JITP device certificates, which are generated using an intermediate CA cert, contain a bundled certificate consisting of the device certificate and the intermediate CA pem.", alias="clientCert")
    private_key: Optional[StrictStr] = Field(default=None, description="The private key associated with the device certificate.", alias="privateKey")
    __properties: ClassVar[List[str]] = ["clientId", "caCert", "clientCert", "privateKey"]
