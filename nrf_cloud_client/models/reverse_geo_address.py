...
class ReverseGeoAddress(BaseModel):
    """
    ReverseGeoAddress
    """ # noqa: E501
    country: StrictStr = Field(description="Country")
    state: StrictStr = Field(description="State, province, or region.")
    country_code: Optional[StrictStr] = Field(default=None, description="Country Code - 2 letter (ISO 3166-1 alpha-2)", alias="countryCode")
    county: Optional[StrictStr] = Field(default=None, description="Geographic region in a country")
    postal_code: Optional[StrictStr] = Field(default=None, description="Postcode, PIN, zip code", alias="postalCode")
    state_code: Optional[StrictStr] = Field(default=None, description="State or province code", alias="stateCode")
    city: Optional[StrictStr] = Field(default=None, description="City, town, municipality, borough, hamlet")
    suburb: Optional[StrictStr] = Field(default=None, description="Geographic region used for residential and commercial purposes")
    street: Optional[StrictStr] = Field(default=None, description="Road, pathway, motorway, highway")
    street_number: Optional[StrictStr] = Field(default=None, description="House or building number", alias="streetNumber")
    __properties: ClassVar[List[str]] = ["country", "state", "countryCode", "county", "postalCode", "stateCode", "city", "suburb", "street", "streetNumber"]
