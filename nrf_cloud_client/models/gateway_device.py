...
class GatewayDevice(BaseModel):
    ...
    sub_type: GatewayDeviceSubType = Field(alias="subType")
    ...
    type: DeviceTypesGateway
    state: Optional[DeviceShadow] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subType": GatewayDeviceSubType.from_dict(obj["subType"]) if obj.get("subType") is not None else None,
            ...
            "type": obj.get("type"),
            "state": DeviceShadow.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
