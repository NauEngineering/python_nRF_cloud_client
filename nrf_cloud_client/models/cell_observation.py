...
class CellObservation(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cell": LteCell.from_dict(obj["cell"]) if obj.get("cell") is not None else None,
