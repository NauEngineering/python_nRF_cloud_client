...
class FotaJobV2Plus(BaseModel):
    ...
    target: FotaJobV2PlusTarget
    description: Optional[StrictStr] = None
    status: FotaV2JobEvents
    ...
    execution_stats: FOTAV2JobExecutionStats = Field(alias="executionStats")
    firmware: FOTAV2JobFirmware
    schedule: Optional[JobSchedule] = None
    target_list_type: Optional[TargetListType] = Field(default=None, alias="targetListType")
    __properties: ClassVar[List[str]] = ["jobId", "target", "description", "status", "statusDetail", "createdAt", "lastUpdatedAt", "completedAt", "name", "executionStats", "firmware", "schedule", "targetListType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobId": obj.get("jobId"),
            "target": FotaJobV2PlusTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
            ...
            "name": obj.get("name"),
            "executionStats": FOTAV2JobExecutionStats.from_dict(obj["executionStats"]) if obj.get("executionStats") is not None else None,
            "firmware": FOTAV2JobFirmware.from_dict(obj["firmware"]) if obj.get("firmware") is not None else None,
