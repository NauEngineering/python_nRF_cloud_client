...
class PaginatedResultFOTAV2JobOrFotaJobV2Plus(BaseModel):
    """
    PaginatedResultFOTAV2JobOrFotaJobV2Plus
    """ # noqa: E501
    items: List[PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
