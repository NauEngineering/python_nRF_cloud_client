...
class LocationTrackerItem(BaseModel):
    """
    LocationTrackerItem
    """ # noqa: E501
    ...
    service_type: TrackerServiceType = Field(alias="serviceType")
    inserted_at: datetime = Field(description="HTML-encoded ISO-8601 date-time string denoting the start or end of a date range. If the string includes only a date, the time is the beginning of the day (00:00:00).", alias="insertedAt")
    lat: StrictStr = Field(description="GPS latitude.")
    lon: StrictStr = Field(description="GPS Longitude.")
    meta: GnssMeta
    uncertainty: StrictStr = Field(description="Radius of the uncertainty circle around the location in meters. Also known as Horizontal Positioning Error (HPE).")
    anchors: Optional[List[AnchorMeta]] = None
    __properties: ClassVar[List[str]] = ["id", "deviceId", "serviceType", "insertedAt", "lat", "lon", "meta", "uncertainty", "anchors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lat": obj.get("lat"),
            "lon": obj.get("lon"),
            "meta": GnssMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "uncertainty": obj.get("uncertainty"),
            "anchors": [AnchorMeta.from_dict(_item) for _item in obj["anchors"]] if obj.get("anchors") is not None else None
        })
        return _obj
