...
GETSINGLECELLLOCATION200RESPONSE_ANY_OF_SCHEMAS = ["PositionResponse", "bytearray"]

class GetSingleCellLocation200Response(BaseModel):
    """
    GetSingleCellLocation200Response
    """

    # data type: bytearray
    anyof_schema_1_validator: Optional[Union[StrictBytes, StrictStr]] = Field(default=None, description="Lat/lon/uncertainty as a binary struct.")
    # data type: PositionResponse
    anyof_schema_2_validator: Optional[PositionResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[PositionResponse, bytearray]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "PositionResponse", "bytearray" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = GetSingleCellLocation200Response.model_construct()
        error_messages = []
        ...
        # validate data type: PositionResponse
        if not isinstance(v, PositionResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `PositionResponse`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in GetSingleCellLocation200Response with anyOf schemas: PositionResponse, bytearray. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_2_validator: Optional[PositionResponse] = None
        try:
            instance.actual_instance = PositionResponse.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into GetSingleCellLocation200Response with anyOf schemas: PositionResponse, bytearray. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], PositionResponse, bytearray]]:
