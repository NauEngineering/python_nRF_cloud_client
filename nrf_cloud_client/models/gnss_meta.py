...
class GnssMeta(BaseModel):
    ...
    """ # noqa: E501
    acc: Union[StrictFloat, StrictInt] = Field(description="Accuracy in (2D 1-sigma) in meters.")
    alt: Union[StrictFloat, StrictInt] = Field(description="Altitude above WGS 84 ellipsoid in meters.")
    spd: Union[StrictFloat, StrictInt] = Field(description="Horizontal speed in meters per second.")
    hdg: Union[StrictFloat, StrictInt] = Field(description="Heading of movement in degrees.")
    __properties: ClassVar[List[str]] = ["acc", "alt", "spd", "hdg"]
