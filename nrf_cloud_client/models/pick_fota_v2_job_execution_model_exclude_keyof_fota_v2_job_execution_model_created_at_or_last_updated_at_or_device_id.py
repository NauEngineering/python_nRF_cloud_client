...
class PickFotaV2JobExecutionModelExcludeKeyofFotaV2JobExecutionModelCreatedAtOrLastUpdatedAtOrDeviceId(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "status", "executionId", "jobId", "statusDetail", "jobDocument"]
