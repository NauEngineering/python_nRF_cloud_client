...
SERVICETYPEVALUE_ANY_OF_SCHEMAS = ["FirmwareTypes", "IdentityServiceType", "LocationServiceType", "MessagesServiceType", "ProvisioningServiceType"]
...
class ServiceTypeValue(BaseModel):
    ...
    # data type: FirmwareTypes
    anyof_schema_1_validator: Optional[FirmwareTypes] = None
    # data type: LocationServiceType
    anyof_schema_2_validator: Optional[LocationServiceType] = None
    # data type: MessagesServiceType
    anyof_schema_3_validator: Optional[MessagesServiceType] = None
    # data type: IdentityServiceType
    anyof_schema_4_validator: Optional[IdentityServiceType] = None
    # data type: ProvisioningServiceType
    anyof_schema_5_validator: Optional[ProvisioningServiceType] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[FirmwareTypes, IdentityServiceType, LocationServiceType, MessagesServiceType, ProvisioningServiceType]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "FirmwareTypes", "IdentityServiceType", "LocationServiceType", "MessagesServiceType", "ProvisioningServiceType" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ServiceTypeValue.model_construct()
        error_messages = []
        # validate data type: FirmwareTypes
        if not isinstance(v, FirmwareTypes):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FirmwareTypes`")
        else:
            return v

        # validate data type: LocationServiceType
        if not isinstance(v, LocationServiceType):
            error_messages.append(f"Error! Input type `{type(v)}` is not `LocationServiceType`")
        else:
            return v

        # validate data type: MessagesServiceType
        if not isinstance(v, MessagesServiceType):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MessagesServiceType`")
        else:
            return v

        # validate data type: IdentityServiceType
        if not isinstance(v, IdentityServiceType):
            error_messages.append(f"Error! Input type `{type(v)}` is not `IdentityServiceType`")
        else:
            return v

        # validate data type: ProvisioningServiceType
        if not isinstance(v, ProvisioningServiceType):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ProvisioningServiceType`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ServiceTypeValue with anyOf schemas: FirmwareTypes, IdentityServiceType, LocationServiceType, MessagesServiceType, ProvisioningServiceType. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[FirmwareTypes] = None
        try:
            instance.actual_instance = FirmwareTypes.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[LocationServiceType] = None
        try:
            instance.actual_instance = LocationServiceType.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[MessagesServiceType] = None
        try:
            instance.actual_instance = MessagesServiceType.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[IdentityServiceType] = None
        try:
            instance.actual_instance = IdentityServiceType.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_5_validator: Optional[ProvisioningServiceType] = None
        try:
            instance.actual_instance = ProvisioningServiceType.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ServiceTypeValue with anyOf schemas: FirmwareTypes, IdentityServiceType, LocationServiceType, MessagesServiceType, ProvisioningServiceType. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FirmwareTypes, IdentityServiceType, LocationServiceType, MessagesServiceType, ProvisioningServiceType]]:
