...
class GroundFixRequest(BaseModel):
    """
    GroundFixRequest
    """ # noqa: E501
    lte: Optional[List[LteCell]] = None
    ltecatm: Optional[List[LteCell]] = None
    nbiot: Optional[List[LteCell]] = None
    wifi: Optional[List[AccessPoint]] = None
    __properties: ClassVar[List[str]] = ["lte", "ltecatm", "nbiot", "wifi"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in lte (list)
        _items = []
        if self.lte:
            for _item_lte in self.lte:
                if _item_lte:
                    _items.append(_item_lte.to_dict())
            _dict['lte'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in ltecatm (list)
        _items = []
        if self.ltecatm:
            for _item_ltecatm in self.ltecatm:
                if _item_ltecatm:
                    _items.append(_item_ltecatm.to_dict())
            _dict['ltecatm'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in nbiot (list)
        _items = []
        if self.nbiot:
            for _item_nbiot in self.nbiot:
                if _item_nbiot:
                    _items.append(_item_nbiot.to_dict())
            _dict['nbiot'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "lte": [LteCell.from_dict(_item) for _item in obj["lte"]] if obj.get("lte") is not None else None,
            "ltecatm": [LteCell.from_dict(_item) for _item in obj["ltecatm"]] if obj.get("ltecatm") is not None else None,
            "nbiot": [LteCell.from_dict(_item) for _item in obj["nbiot"]] if obj.get("nbiot") is not None else None,
            "wifi": [AccessPoint.from_dict(_item) for _item in obj["wifi"]] if obj.get("wifi") is not None else None
        })
        return _obj
