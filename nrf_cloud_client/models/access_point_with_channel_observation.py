...
class AccessPointWithChannelObservation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["macAddress", "ssid", "signalStrength", "age", "signalToNoiseRatio", "channel", "observedAt"]
