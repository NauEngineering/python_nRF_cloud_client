...
class FOTAJobsApi:
    ...
    def apply_fota_job(
        ...
        _param = self._apply_fota_job_serialize(
            job_id=job_id,
    ...
    @validate_call
    def apply_fota_job_with_http_info(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def apply_fota_job_without_preload_content(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _apply_fota_job_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/fota-jobs/{jobId}/apply',
    ...
    def cancel_fota_job(
        ...
        _param = self._cancel_fota_job_serialize(
            job_id=job_id,
            reason=reason,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cancel_fota_job_with_http_info(
        self,
        job_id: Annotated[str, Field(strict=True)],
        reason: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cancel_fota_job_without_preload_content(
        self,
        job_id: Annotated[str, Field(strict=True)],
        reason: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _cancel_fota_job_serialize(
        self,
        job_id,
        reason,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/fota-jobs/{jobId}/cancel',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def create_fota_job(
        self,
        create_job_input: CreateJobInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> CreateFOTAJob201Response:
        """CreateFOTAJob


        :param create_job_input: (required)
        :type create_job_input: CreateJobInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_fota_job_serialize(
            create_job_input=create_job_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_fota_job_with_http_info(
        self,
        create_job_input: CreateJobInput,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateFOTAJob201Response]:
        """CreateFOTAJob
    ...
    @validate_call
    def create_fota_job_without_preload_content(
        self,
        create_job_input: CreateJobInput,
        _request_timeout: Union[
            None,
    ...
    def _create_fota_job_serialize(
        self,
        create_job_input,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if create_job_input is not None:
            _body_params = create_job_input
    ...
    def delete_fota_job(
        ...
        _param = self._delete_fota_job_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_fota_job_with_http_info(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_fota_job_without_preload_content(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _delete_fota_job_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
    ...
    def fetch_fota_job(
        ...
        _param = self._fetch_fota_job_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_fota_job_with_http_info(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_fota_job_without_preload_content(
        self,
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def list_fota_jobs(
        ...
        _param = self._list_fota_jobs_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultFOTAV2JobOrFotaJobV2Plus",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_fota_jobs_with_http_info(
        self,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultFOTAV2JobOrFotaJobV2Plus]:
        """ListFOTAJobs
    ...
    @validate_call
    def list_fota_jobs_without_preload_content(
        self,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
        _request_timeout: Union[
