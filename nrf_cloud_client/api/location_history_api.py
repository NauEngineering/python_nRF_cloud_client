...
class LocationHistoryApi:
    ...
    def delete_location_history(
        ...
        _param = self._delete_location_history_serialize(
            device_id=device_id,
            id=id,
    ...
    @validate_call
    def delete_location_history_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_location_history_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    def _delete_location_history_serialize(
        self,
        device_id,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/location/history/{deviceId}/{id}',
    ...
    def get_location_history(
        self,
        device_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="This is the canonical device id that is an optional parameter. Specify a device id to get its location history. If a device id is not provided, location history for all devices are returned. You must have admin privileges to perform this operation.")] = None,
        latest: Annotated[Optional[StrictBool], Field(description="Get the last known location for all devices or a single device (if deviceId is supplied). You must have admin privileges.")] = None,
        ...
        device_identifier: Optional[Annotated[str, Field(strict=True)]] = None,
        inclusive_start: Optional[datetime] = None,
        inclusive_end: Optional[datetime] = None,
        tags: Annotated[Optional[List[StrictStr]], Field(description="If specified, only return location history for devices that have one of these Device Groups (tags). You must have admin privileges.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Get location history for one, all, or a group of devices specified by tags parameter.  Notes: - Location history data expires after ~6 months (27 weeks) - The `serviceType` field is intentionally empty for location data before December 10th 2021  __Basic Request for device history__: ```sh curl -G $API_HOST/v1/location/history -d \"deviceId=$DEVICE_ID&start=2022-10-15T06:00:00.000Z&end=2022-10-16T18:30:00.000Z\" -H \"Authorization: Bearer $API_KEY\" ```  __Paginated Request__: ```sh export PAGE_NEXT_TOKEN=$(curl -G $API_HOST/v1/location/history -d \"deviceId=$DEVICE_ID&start=2022-10-15T06:00:00.000Z&end=2022-10-16T18:30:00.000Z\" -H \"Authorization: Bearer $API_KEY\" | jq .pageNextToken)  curl -G $API_HOST/v1/location/history -d \"deviceId=$DEVICE_ID\" --data-urlencode \"pageNextToken=$PAGE_NEXT_TOKEN\" -H \"Authorization: Bearer $API_KEY\" ```  __Request all devices location history__&dagger;: ```sh curl -G $API_HOST/v1/location/history -H \"Authorization: Bearer $API_KEY\" ```  __Request all devices last known location__&dagger;: ```sh curl -G $API_HOST/v1/location/history -d \"latest=true\" -H \"Authorization: Bearer $API_KEY\" ```  &dagger; Requires admin privileges

        :param device_id: This is the canonical device id that is an optional parameter. Specify a device id to get its location history. If a device id is not provided, location history for all devices are returned. You must have admin privileges to perform this operation.
        :type device_id: str
        :param latest: Get the last known location for all devices or a single device (if deviceId is supplied). You must have admin privileges.
        :type latest: bool
        :param page_sort:
        ...
        :param inclusive_start:
        :type inclusive_start: datetime
        :param inclusive_end:
        :type inclusive_end: datetime
        :param tags: If specified, only return location history for devices that have one of these Device Groups (tags). You must have admin privileges.
        :type tags: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_location_history_serialize(
            device_id=device_id,
            latest=latest,
            page_sort=page_sort,
            start=start,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultLocationTrackerItem",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_location_history_with_http_info(
        self,
        device_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="This is the canonical device id that is an optional parameter. Specify a device id to get its location history. If a device id is not provided, location history for all devices are returned. You must have admin privileges to perform this operation.")] = None,
        latest: Annotated[Optional[StrictBool], Field(description="Get the last known location for all devices or a single device (if deviceId is supplied). You must have admin privileges.")] = None,
        page_sort: Optional[PageSort] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultLocationTrackerItem]:
        """GetLocationHistory
    ...
    @validate_call
    def get_location_history_without_preload_content(
        self,
        device_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="This is the canonical device id that is an optional parameter. Specify a device id to get its location history. If a device id is not provided, location history for all devices are returned. You must have admin privileges to perform this operation.")] = None,
        latest: Annotated[Optional[StrictBool], Field(description="Get the last known location for all devices or a single device (if deviceId is supplied). You must have admin privileges.")] = None,
        page_sort: Optional[PageSort] = None,
    ...
    def _get_location_history_serialize(
        self,
        device_id,
        latest,
        page_sort,
        ...
        if inclusive_start is not None:
            if isinstance(inclusive_start, datetime):
                _query_params.append(
                    (
                        'inclusiveStart',
                        inclusive_start.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
        ...
        if inclusive_end is not None:
            if isinstance(inclusive_end, datetime):
                _query_params.append(
                    (
                        'inclusiveEnd',
                        inclusive_end.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
            else:
                _query_params.append(('inclusiveEnd', inclusive_end))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/location/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
