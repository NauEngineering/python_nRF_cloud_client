...
class BulkOpsRequestsApi:
    ...
    @validate_call
    def fetch_bulk_ops_request(
        self,
        bulk_ops_request_id: Annotated[str, Field(strict=True)],
        ...
        :param bulk_ops_request_id: (required)
        :type bulk_ops_request_id: str
        ...
        _param = self._fetch_bulk_ops_request_serialize(
            bulk_ops_request_id=bulk_ops_request_id,
    ...
    @validate_call
    def fetch_bulk_ops_request_with_http_info(
        self,
        bulk_ops_request_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BulkOpsRequestDetails]:
        """FetchBulkOpsRequest
    ...
    @validate_call
    def fetch_bulk_ops_request_without_preload_content(
        self,
        bulk_ops_request_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _fetch_bulk_ops_request_serialize(
        self,
        bulk_ops_request_id,
        _request_auth,
        _content_type,
        ...
        if bulk_ops_request_id is not None:
            _path_params['bulkOpsRequestId'] = bulk_ops_request_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bulk-ops-requests/{bulkOpsRequestId}',
    ...
    @validate_call
    def list_bulk_ops_requests(
        self,
        status: Optional[BulkOpsRequestStatus] = None,
        start_requested_at: Optional[StrictStr] = None,
        end_requested_at: Optional[StrictStr] = None,
        page_limit: Optional[Union[StrictFloat, StrictInt]] = None,
        ...
        :param status:
        :type status: BulkOpsRequestStatus
        :param start_requested_at:
        :type start_requested_at: str
        :param end_requested_at:
        :type end_requested_at: str
        :param page_limit:
        :type page_limit: float
        ...
        _param = self._list_bulk_ops_requests_serialize(
            status=status,
            start_requested_at=start_requested_at,
            end_requested_at=end_requested_at,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultBulkOpsRequestDetails",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_bulk_ops_requests_with_http_info(
        self,
        status: Optional[BulkOpsRequestStatus] = None,
        start_requested_at: Optional[StrictStr] = None,
        end_requested_at: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultBulkOpsRequestDetails]:
        """ListBulkOpsRequests
    ...
    @validate_call
    def list_bulk_ops_requests_without_preload_content(
        self,
        status: Optional[BulkOpsRequestStatus] = None,
        start_requested_at: Optional[StrictStr] = None,
        end_requested_at: Optional[StrictStr] = None,
    ...
    def _list_bulk_ops_requests_serialize(
        self,
        status,
        start_requested_at,
        end_requested_at,
        ...
        if start_requested_at is not None:
            ...
            _query_params.append(('startRequestedAt', start_requested_at))
            
        if end_requested_at is not None:
            
            _query_params.append(('endRequestedAt', end_requested_at))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/bulk-ops-requests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
