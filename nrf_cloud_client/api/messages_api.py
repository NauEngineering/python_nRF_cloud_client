...
class MessagesApi:
    ...
    def list_messages(
        ...
        exclusive_end: Optional[datetime] = None,
        end: Optional[datetime] = None,
        app_id: Annotated[Optional[Annotated[str, Field(strict=True, max_length=64)]], Field(description="Filter returned messages by appId. Primarily used by Asset Tracker, AppId is taken from the \"appId\" property of the message body and is intended to represent the type of data being sent. This can be used to categorize your messages for easy filtering when using the same topic.")] = None,
        device_id: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="A device Id to fetch messages for. Can be specified with appId or topic.")] = None,
        topic: Annotated[Optional[StrictStr], Field(description="Fetch messages for a single topic. Can be specified with deviceId.")] = None,
        ...
        Fetch historical device messages.  Currently supported parameter combinations:  `appId + deviceId`  `topic + deviceId`  `appId`  `deviceId`  `topic`  Not supported:  `appId + topic`  `appId + topic + deviceId`  For more information, see our [nRF Cloud documentation on device messages](https://docs.nordicsemi.com/bundle/nrf-cloud/page/Devices/MessagesAndAlerts/DeviceMessages.html).
        ...
        :type start: datetime
        :param exclusive_end:
        :type exclusive_end: datetime
        :param end:
        :type end: datetime
        :param app_id: Filter returned messages by appId. Primarily used by Asset Tracker, AppId is taken from the \"appId\" property of the message body and is intended to represent the type of data being sent. This can be used to categorize your messages for easy filtering when using the same topic.
        :type app_id: str
        :param device_id: A device Id to fetch messages for. Can be specified with appId or topic.
        :type device_id: str
        :param topic: Fetch messages for a single topic. Can be specified with deviceId.
        :type topic: str
        :param page_limit:
        :type page_limit: int
        :param page_sort:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultDeviceMessage",
        }
    ...
    def list_messages_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultDeviceMessage]:
        """ListMessages
    ...
    def send_device_message(
        ...
        device_message_input: DeviceMessageInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Allows a user or [IP device](https://docs.nordicsemi.com/bundle/nrf-cloud/page/Devices/Properties/Types.html) to send a message that is subsequently published over an MQTT topic, on behalf of the IP device whose deviceId is specified. The device ID for the message comes from the topic. For instance, if the topic property on the request is `m/d/nrf-352656101081837/d2c/custom`, the device ID determined for the message will be `'nrf-352656101081837'`.  For [dictionary based binary logs](https://docs.nordicsemi.com/bundle/ncs-latest/page/zephyr/services/logging/index.html#dictionary-based_logging) via the `d2c/bin` topic, the message must be base64 encoded. For instance, for the device  `nrf-352656101081837` the request body would be: ```json {   \"topic\": \"d/nrf-352656101081837/d2c/bin\",   \"message\": \"blJGQwAAAAAd2qCkkAEAAAEAAABoZWxsbyB3b3JsZA==\" } ```  For more information, see [Sending device messages](https://docs.nordicsemi.com/bundle/nrf-cloud/page/Devices/MessagesAndAlerts/DeviceMessages.html#sending-device-messages).

        :param device_id: (required)
        :type device_id: str
        :param device_message_input: (required)
        :type device_message_input: DeviceMessageInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._send_device_message_serialize(
            device_id=device_id,
            device_message_input=device_message_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def send_device_message_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        device_message_input: DeviceMessageInput,
        _request_timeout: Union[
    ...
    @validate_call
    def send_device_message_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        device_message_input: DeviceMessageInput,
        _request_timeout: Union[
    ...
    def _send_device_message_serialize(
        self,
        device_id,
        device_message_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if device_message_input is not None:
            _body_params = device_message_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/devices/{deviceId}/messages',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
