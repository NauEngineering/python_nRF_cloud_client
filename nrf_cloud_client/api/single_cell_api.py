...
class SingleCellApi:
    ...
    def get_single_cell_location(
        ...
        format: Optional[SingleCellFormat] = None,
        ...
        """(Deprecated) GetSingleCellLocation

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">This endpoint has been deprecated. Please use the <a href=\"#tag/Ground-Fix\">ground fix endpoint</a> instead.</div>  Gets the lat, lon, and uncertainty values based on the id of the LTE cell passed. Returns a binary payload or JSON, depending on the format argument. Binary by default. When returning binary, the by content-type response header is \"application/octet-stream\". ```sh curl -G $API_HOST/v1/location/single-cell -d \"mcc=244\" -d \"mnc=91\" -d \"tac=4099\" -d \"eci=36078631\" -d \"format=json\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" ```
        ...
        """ # noqa: E501
        warnings.warn("GET /location/single-cell is deprecated.", DeprecationWarning)

        _param = self._get_single_cell_location_serialize(
            mcc=mcc,
            mnc=mnc,
            tac=tac,
            eci=eci,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetSingleCellLocation200Response",
        }
    ...
    @validate_call
    def get_single_cell_location_with_http_info(
        self,
        mcc: StrictInt,
        mnc: Any,
        tac: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetSingleCellLocation200Response]:
        """(Deprecated) GetSingleCellLocation
    ...
    @validate_call
    def get_single_cell_location_without_preload_content(
        self,
        mcc: StrictInt,
        mnc: Any,
        tac: StrictInt,
    ...
    def _get_single_cell_location_serialize(
        self,
        mcc,
        mnc,
        tac,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/location/single-cell',
