...
class GroundFixApi:
    ...
    @validate_call
    def get_location_from_cells_or_wifi_networks(
        self,
        get_location_from_cells_or_wifi_networks_request: GetLocationFromCellsOrWifiNetworksRequest,
        do_reply: Optional[Any] = None,
        fallback: Optional[StrictBool] = None,
        hi_conf: Optional[StrictBool] = None,
        dist: Optional[Union[StrictFloat, StrictInt]] = None,
        cont: Optional[StrictBool] = None,
        ...
        Gets the lat, lon, and uncertainty values for the LTE cell(s) or wifi access points passed. Wifi will be prioritized and fall back to LTE if unavailable.  At least two Access Points are required.  Return JSON payload.  __Basic Request__: ```sh curl -X POST \"$API_HOST/v1/location/ground-fix\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -d \"{\\\"lte\\\":[{\\\"mcc\\\": 244, \\\"mnc\\\": 91,\\\"tac\\\": 4099,\\\"eci\\\":36078631}], \\\"wifi\\\":[{\\\"macAddress\\\": \\\"00-18-39-59-8C-53\\\", \\\"ssid\\\": \\\"my-wifi-network\\\", \\\"signalStrength\\\": -42}, {\\\"macAddress\\\": \\\"00:21:55:61:F3:0A\\\", \\\"ssid\\\": \\\"my-other-wifi-network\\\", \\\"signalStrength\\\": -22}]}\" ```  __Save device location and silence response__: ```sh curl --verbose -X POST \"$API_HOST/v1/location/ground-fix?doReply=false\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -d \"{\\\"lte\\\":[{\\\"mcc\\\": 244, \\\"mnc\\\": 91,\\\"tac\\\": 4099,\\\"eci\\\":36078631}], \\\"wifi\\\":[{\\\"macAddress\\\": \\\"00-18-39-59-8C-53\\\", \\\"ssid\\\": \\\"my-wifi-network\\\", \\\"signalStrength\\\": -42}, {\\\"macAddress\\\": \\\"00:21:55:61:F3:0A\\\", \\\"ssid\\\": \\\"my-other-wifi-network\\\", \\\"signalStrength\\\": -22}]}\" ```

        :param get_location_from_cells_or_wifi_networks_request: (required)
        :type get_location_from_cells_or_wifi_networks_request: GetLocationFromCellsOrWifiNetworksRequest
        :param do_reply:
        :type do_reply: DoReplyFlag
        :param fallback:
        :type fallback: bool
        :param hi_conf:
        :type hi_conf: bool
        ...
        _param = self._get_location_from_cells_or_wifi_networks_serialize(
            get_location_from_cells_or_wifi_networks_request=get_location_from_cells_or_wifi_networks_request,
            do_reply=do_reply,
            fallback=fallback,
            hi_conf=hi_conf,
            dist=dist,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GroundFixResponseWithFulfillment",
        }
    ...
    @validate_call
    def get_location_from_cells_or_wifi_networks_with_http_info(
        self,
        get_location_from_cells_or_wifi_networks_request: GetLocationFromCellsOrWifiNetworksRequest,
        do_reply: Optional[Any] = None,
        fallback: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GroundFixResponseWithFulfillment]:
        """GetLocationFromCellsOrWifiNetworks
    ...
    @validate_call
    def get_location_from_cells_or_wifi_networks_without_preload_content(
        self,
        get_location_from_cells_or_wifi_networks_request: GetLocationFromCellsOrWifiNetworksRequest,
        do_reply: Optional[Any] = None,
        fallback: Optional[StrictBool] = None,
    ...
    def _get_location_from_cells_or_wifi_networks_serialize(
        self,
        get_location_from_cells_or_wifi_networks_request,
        do_reply,
        fallback,
        hi_conf,
        dist,
        ...
        if do_reply is not None:
            
            _query_params.append(('doReply', do_reply))
            
        if fallback is not None:
            
            _query_params.append(('fallback', fallback))
            
        if hi_conf is not None:
            
            _query_params.append(('hiConf', hi_conf))
        ...
        if cont is not None:
            ...
            _query_params.append(('cont', cont))
        ...
        if get_location_from_cells_or_wifi_networks_request is not None:
            _body_params = get_location_from_cells_or_wifi_networks_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/location/ground-fix',
