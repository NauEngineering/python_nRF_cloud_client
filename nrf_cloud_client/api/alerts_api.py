...
class AlertsApi:
    ...
    @validate_call
    def archive_device_alert(
        self,
        id: Annotated[str, Field(strict=True, description="The unique identifier for the alert")],
        ...
        :param id: The unique identifier for the alert (required)
        :type id: str
        ...
        _param = self._archive_device_alert_serialize(
            id=id,
    ...
    @validate_call
    def archive_device_alert_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="The unique identifier for the alert")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def archive_device_alert_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="The unique identifier for the alert")],
        _request_timeout: Union[
            None,
    ...
    def _archive_device_alert_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/alerts/{id}/archive',
    ...
    def list_device_alerts(
        self,
        device_ids: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Fetch alerts optionally by device ids.")] = None,
        status: Annotated[Optional[AlertStatus], Field(description="Fetch alerts optionally by Status. By default, both `ACTIVE` and `ARCHIVED` alerts are returned.")] = None,
        ...
        :param device_ids: Fetch alerts optionally by device ids.
        :type device_ids: List[str]
        :param status: Fetch alerts optionally by Status. By default, both `ACTIVE` and `ARCHIVED` alerts are returned.
        ...
        _param = self._list_device_alerts_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultDeviceAlert",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_device_alerts_with_http_info(
        self,
        device_ids: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Fetch alerts optionally by device ids.")] = None,
        status: Annotated[Optional[AlertStatus], Field(description="Fetch alerts optionally by Status. By default, both `ACTIVE` and `ARCHIVED` alerts are returned.")] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultDeviceAlert]:
        """ListDeviceAlerts
    ...
    @validate_call
    def list_device_alerts_without_preload_content(
        self,
        device_ids: Annotated[Optional[List[Annotated[str, Field(strict=True)]]], Field(description="Fetch alerts optionally by device ids.")] = None,
        status: Annotated[Optional[AlertStatus], Field(description="Fetch alerts optionally by Status. By default, both `ACTIVE` and `ARCHIVED` alerts are returned.")] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
    ...
    def _list_device_alerts_serialize(
        self,
        device_ids,
        status,
        page_limit,
    ...
    def restore_device_alert(
        ...
        _param = self._restore_device_alert_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def restore_device_alert_with_http_info(
        self,
        id: Annotated[str, Field(strict=True, description="The unique identifier for the alert")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def restore_device_alert_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True, description="The unique identifier for the alert")],
        _request_timeout: Union[
            None,
    ...
    def _restore_device_alert_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/alerts/{id}/restore',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
