...
class GatewaysApi:
    ...
    @validate_call
    def start_scan_for_ble_devices(
        self,
        device_id: Annotated[str, Field(strict=True)],
        ble_scan_config: Optional[BLEScanConfig] = None,
        ...
        """(Deprecated) StartScanForBLEDevices

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">Support for Bluetooth Low Energy gateway devices will be removed soon.</div>  Initiate a gateway scan for BLE devices.

        :param device_id: (required)
        :type device_id: str
        :param ble_scan_config:
        :type ble_scan_config: BLEScanConfig
        ...
        """ # noqa: E501
        warnings.warn("POST /devices/{deviceId}/scan is deprecated.", DeprecationWarning)

        _param = self._start_scan_for_ble_devices_serialize(
            device_id=device_id,
            ble_scan_config=ble_scan_config,
    ...
    @validate_call
    def start_scan_for_ble_devices_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        ble_scan_config: Optional[BLEScanConfig] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def start_scan_for_ble_devices_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        ble_scan_config: Optional[BLEScanConfig] = None,
        _request_timeout: Union[
    ...
    def _start_scan_for_ble_devices_serialize(
        self,
        device_id,
        ble_scan_config,
        _request_auth,
        ...
        if ble_scan_config is not None:
            _body_params = ble_scan_config
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/devices/{deviceId}/scan',
