...
class AccountApi:
    ...
    def fetch_account_info(
        ...
        _param = self._fetch_account_info_serialize(
    ...
    @validate_call
    def fetch_account_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def fetch_account_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_account_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def fetch_api_usage_summary(
        ...
        Fetch a summary of your usage of nRF Cloud commercial services for the current and previous month.  In the response, `currentDevices` is the current number for each main type of device in your account. It is thus a snapshot metric, and can fluctuate. The other metrics are cumulative for the month, and reset on the first of each month.  ```sh curl -G $API_HOST/v1/account/usage/summary -H \"Authorization: Bearer $API_KEY\" -H \"Content-Type: application/json\" ```
        ...
        _param = self._fetch_api_usage_summary_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def fetch_api_usage_summary_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiUsageMetricsSummary]:
        """FetchApiUsageSummary
    ...
    @validate_call
    def fetch_api_usage_summary_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_api_usage_summary_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/usage/summary',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def generate_service_evaluation_token(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Generates a JSON Web Token (JWT) for evaluating nRF Cloud Location Services by proxy servers. You may use this token to authenticate proxy server requests to any of the Location Service endpoints that indicate `Service Evaluation Token` among their Authorizations.  Calling this endpoint for the first time will start your 30-day evaluation period, after which you will need to contact [Nordic Sales](https://www.nordicsemi.com/About-us/Contact-Us) if you want to extend your evaluation period, or enter into a business agreement for commercial cloud-to-cloud use.  The JWT claims are set automatically by nRF Cloud when this token is generated. Although it can be regenerated upon request, the initial 30-day trial period remains unchanged.  For more information see [JWT authentication for nRF Cloud](https://docs.nordicsemi.com/bundle/nrf-cloud/page/Devices/Security/JWT.html).
        ...
        _param = self._generate_service_evaluation_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def generate_service_evaluation_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServiceKeyTokenResponse]:
        """GenerateServiceEvaluationToken
    ...
    @validate_call
    def generate_service_evaluation_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _generate_service_evaluation_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account/service-evaluation-token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def generate_service_key_and_token(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Creates a new service key pair for authenticating REST endpoints that support JWTs. The public key is stored in nRF Cloud for use in JWT verification. The response contains the private key and a JWT signed by it, with a one year expiry. The private key can be used to generate additional JWTs with an expiry of your choice.  <div style=\"background-color: #fff3cd; color: #856404; text-align: center; border: 1px solid #ffeeba; border-radius: .25rem; padding: .75rem 1.25rem\">Calling this endpoint will overwrite an existing service key, causing any JWTs signed by the previous key to fail verification!</div>  <div style=\"background-color: #fff3cd; color: #856404; text-align: center; border: 1px solid #ffeeba; border-radius: .25rem; padding: .75rem 1.25rem; margin-top: 10px;\">You will not be allowed to use this service key unless you have declared proxy usage declarations for the service you intend to use.</div>
        ...
        _param = self._generate_service_key_and_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GenerateServiceKeyAndToken200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def generate_service_key_and_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateServiceKeyAndToken200Response]:
        """GenerateServiceKeyAndToken
    ...
    @validate_call
    def generate_service_key_and_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _generate_service_key_and_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account/service-key-and-token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_service_evaluation_token(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Returns an existing Service Evaluation Token. Calling this endpoint will not start your evaluation period. You may create one by calling the [GenerateServiceEvaluationToken](#operation/GenerateServiceEvaluationToken) endpoint.
        ...
        _param = self._get_service_evaluation_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_service_evaluation_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_service_evaluation_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_service_evaluation_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_service_token(
        ...
        _param = self._get_service_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetServiceToken200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_service_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetServiceToken200Response]:
        """GetServiceToken
    ...
    @validate_call
    def get_service_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_service_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/service-token',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_api_usage(
        ...
        inclusive_start: Any,
        exclusive_end: Any,
        page_sort: Optional[PageSort] = None,
        ...
        Retrieve a list of your daily or monthly usage of nRF Cloud commercial services for a specified date range. For daily usage metrics, pass a date range in YYYY-MM-DD format. Otherwise, use the YYYY-MM format to receive monthly usage metrics.  The format of `inclusiveStart` and `exclusiveEnd` must match. Both must be YYYY-MM or YYYY-MM-DD format.  The list will not contain any records for 0 usage. In other words, a daily (or monthly) record is only returned if usage occurred on that day (or during that month).  As of June 2022 we do not keep a record of the number of devices in your account at the end of each day. Therefore, the response will only contain usage records for Location Services, Firmware-over-the-air (FOTA) job executions, and stored device messages. This may change in the future.  The following example illustrates how to retrieve a list of daily metrics. If you prefer monthly metrics, you would change this example to use `inclusiveStart=2022-01&exclusiveEnd=2022-03`. ```sh curl -G $API_HOST/v1/account/usage -d \"inclusiveStart=2022-01-01&exclusiveEnd=2022-03-01\" -H \"Authorization: Bearer $API_KEY\" -H \"Content-Type: application/json\" ``` By default records are sorted by date in ascending order. Set `pageSort=desc` to sort in descending order.

        :param inclusive_start: (required)
        :type inclusive_start: UsageMetricDate
        :param exclusive_end: (required)
        :type exclusive_end: UsageMetricDate
        :param page_sort:
        :type page_sort: PageSort
        :param page_limit:
        :type page_limit: int
        ...
        _param = self._list_api_usage_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultOmitApiUsageMetricRecordTenantId",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_api_usage_with_http_info(
        self,
        inclusive_start: Any,
        exclusive_end: Any,
        page_sort: Optional[PageSort] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultOmitApiUsageMetricRecordTenantId]:
        """ListApiUsage
    ...
    @validate_call
    def list_api_usage_without_preload_content(
        self,
        inclusive_start: Any,
        exclusive_end: Any,
        page_sort: Optional[PageSort] = None,
    ...
    def _list_api_usage_serialize(
        ...
        # process the path parameters
        # process the query parameters
        if inclusive_start is not None:
            
            _query_params.append(('inclusiveStart', inclusive_start))
            
        if exclusive_end is not None:
            
            _query_params.append(('exclusiveEnd', exclusive_end))
            
        if page_sort is not None:
            
            _query_params.append(('pageSort', page_sort.value))
    ...
    def list_invoices(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultInvoiceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_invoices_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultInvoiceResponse]:
        """ListInvoices
    ...
    def _list_invoices_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account/invoices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_tags_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultDeviceTag]:
        """ListTags
