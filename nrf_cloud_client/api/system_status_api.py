...
class SystemStatusApi:
    ...
    def get_system_status(
        ...
        Get the status of the nRF Cloud system, returning a JSON object. A \"status\" of \"offline\" is set when maintenance upgrades are in progress. A \"login\" of \"false\" signifies that user logins to the nrfcloud.com portal have been temporarily disabled.
