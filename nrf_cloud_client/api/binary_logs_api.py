...
class BinaryLogsApi:
    ...
    @validate_call
    def fetch_binary_logs_url(
        self,
        device_id: Annotated[str, Field(strict=True)],
        start: Annotated[Optional[datetime], Field(description="By default, the start time for the range is 24 hours before the current time. The range between start and end cannot be greater than 24 hours.")] = None,
        end: Annotated[Optional[datetime], Field(description="By default, the end time for the range is the current time. The range between start and end cannot be greater than 24 hours.")] = None,
        ...
        Fetches the URL to a zip file containing one or more binary log files for the requested device and time range. The returned URL can be used to download the zip file.  For more information, see the [nRF Cloud documentation on binary logs](https://docs.nordicsemi.com/bundle/nrf-cloud/page/Devices/MessagesAndAlerts/AlertsAndLogs/Logs.html#downloading-binary-logs-through-the-api).

        :param device_id: (required)
        :type device_id: str
        :param start: By default, the start time for the range is 24 hours before the current time. The range between start and end cannot be greater than 24 hours.
        :type start: datetime
        :param end: By default, the end time for the range is the current time. The range between start and end cannot be greater than 24 hours.
        :type end: datetime
        ...
        _param = self._fetch_binary_logs_url_serialize(
            device_id=device_id,
            start=start,
            end=end,
    ...
    @validate_call
    def fetch_binary_logs_url_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        start: Annotated[Optional[datetime], Field(description="By default, the start time for the range is 24 hours before the current time. The range between start and end cannot be greater than 24 hours.")] = None,
        end: Annotated[Optional[datetime], Field(description="By default, the end time for the range is the current time. The range between start and end cannot be greater than 24 hours.")] = None,
    ...
    @validate_call
    def fetch_binary_logs_url_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        start: Annotated[Optional[datetime], Field(description="By default, the start time for the range is 24 hours before the current time. The range between start and end cannot be greater than 24 hours.")] = None,
        end: Annotated[Optional[datetime], Field(description="By default, the end time for the range is the current time. The range between start and end cannot be greater than 24 hours.")] = None,
    ...
    def _fetch_binary_logs_url_serialize(
        self,
        device_id,
        start,
        end,
