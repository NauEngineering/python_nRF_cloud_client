...
class FOTAJobExecutionsApi:
    ...
    @validate_call
    def fetch_current_pending_fota_job_execution(
        self,
        device_id: Annotated[str, Field(strict=True)],
        firmware_type: Annotated[Optional[FirmwareTypes], Field(description="Return only executions with the given firmware type")] = None,
        ...
        :type device_id: str
        :param firmware_type: Return only executions with the given firmware type
        :type firmware_type: FirmwareTypes
        ...
        _param = self._fetch_current_pending_fota_job_execution_serialize(
            device_id=device_id,
    ...
    @validate_call
    def fetch_current_pending_fota_job_execution_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        firmware_type: Annotated[Optional[FirmwareTypes], Field(description="Return only executions with the given firmware type")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_current_pending_fota_job_execution_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        firmware_type: Annotated[Optional[FirmwareTypes], Field(description="Return only executions with the given firmware type")] = None,
        _request_timeout: Union[
    ...
    def _fetch_current_pending_fota_job_execution_serialize(
        self,
        device_id,
        firmware_type,
        _request_auth,
        ...
        if firmware_type is not None:
            ...
            _query_params.append(('firmwareType', firmware_type.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fota-job-executions/{deviceId}/current',
    ...
    def fetch_fota_job_execution(
        ...
        _param = self._fetch_fota_job_execution_serialize(
            device_id=device_id,
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchFOTAJobExecution200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def fetch_fota_job_execution_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchFOTAJobExecution200Response]:
        """FetchFOTAJobExecution
    ...
    @validate_call
    def fetch_fota_job_execution_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        job_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    def _fetch_fota_job_execution_serialize(
        self,
        device_id,
        job_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fota-job-executions/{deviceId}/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_fota_job_execution_statuses(
        self,
        job_id: Annotated[str, Field(strict=True)],
        status: Optional[FotaV2JobExecutionEvents] = None,
        ...
        :type job_id: str
        :param status:
        :type status: FotaV2JobExecutionEvents
        :param page_limit:
        :type page_limit: int
        ...
        _param = self._list_fota_job_execution_statuses_serialize(
            job_id=job_id,
            status=status,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultFOTAJobExecutionState",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_fota_job_execution_statuses_with_http_info(
        self,
        job_id: Annotated[str, Field(strict=True)],
        status: Optional[FotaV2JobExecutionEvents] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultFOTAJobExecutionState]:
        """ListFOTAJobExecutionStatuses
    ...
    @validate_call
    def list_fota_job_execution_statuses_without_preload_content(
        self,
        job_id: Annotated[str, Field(strict=True)],
        status: Optional[FotaV2JobExecutionEvents] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
    ...
    def _list_fota_job_execution_statuses_serialize(
        self,
        job_id,
        status,
        page_limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fota-job-execution-statuses/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_fota_job_executions_for_device(
        self,
        device_id: Annotated[str, Field(strict=True)],
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
        ...
        _param = self._list_fota_job_executions_for_device_serialize(
            device_id=device_id,
            page_limit=page_limit,
            page_next_token=page_next_token,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultFOTAJobExecution",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_fota_job_executions_for_device_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultFOTAJobExecution]:
        """ListFOTAJobExecutionsForDevice
    ...
    @validate_call
    def list_fota_job_executions_for_device_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
    ...
    def _list_fota_job_executions_for_device_serialize(
        self,
        device_id,
        page_limit,
        page_next_token,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/fota-job-executions/{deviceId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_fota_job_execution_status(
        self,
        device_id: Annotated[str, Field(strict=True)],
        job_id: Annotated[str, Field(strict=True)],
        update_fota_job_execution_status_request: UpdateFOTAJobExecutionStatusRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param job_id: (required)
        :type job_id: str
        :param update_fota_job_execution_status_request: (required)
        :type update_fota_job_execution_status_request: UpdateFOTAJobExecutionStatusRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_fota_job_execution_status_serialize(
            device_id=device_id,
            job_id=job_id,
            update_fota_job_execution_status_request=update_fota_job_execution_status_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_fota_job_execution_status_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        job_id: Annotated[str, Field(strict=True)],
        update_fota_job_execution_status_request: UpdateFOTAJobExecutionStatusRequest,
    ...
    @validate_call
    def update_fota_job_execution_status_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        job_id: Annotated[str, Field(strict=True)],
        update_fota_job_execution_status_request: UpdateFOTAJobExecutionStatusRequest,
    ...
    def _update_fota_job_execution_status_serialize(
        self,
        device_id,
        job_id,
        update_fota_job_execution_status_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_fota_job_execution_status_request is not None:
            _body_params = update_fota_job_execution_status_request
