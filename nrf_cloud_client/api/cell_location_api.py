...
class CellLocationApi:
    ...
    def get_location_from_cells(
        ...
        <div style=\"background-color: #fff3cd; color: #856404; text-align: center; border: 1px solid #ffeeba; border-radius: .25rem; padding: .75rem 1.25rem\">This endpoint has an alternative. See the <a href=\"#tag/Ground-Fix\">ground fix endpoint</a> for more details.</div>  Gets the lat, lon, and uncertainty values for the LTE cell(s) passed. If the optional `nmr` parameter is passed the endpoint operates in a \"multi-cell\" mode, using more than one cell to determine a more accurate location.  __Basic Request__: ```sh curl -X POST \"$API_HOST/v1/location/cell\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -d \"{\\\"lte\\\":[{\\\"mcc\\\": 244, \\\"mnc\\\": 91,\\\"tac\\\": 4099,\\\"eci\\\":36078631}]}\" ```  __Save device location and silence response__: ```sh curl --verbose -X POST \"$API_HOST/v1/location/cell?doReply=0\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -d \"{\\\"lte\\\":[{\\\"mcc\\\": 244, \\\"mnc\\\": 91,\\\"tac\\\": 4099,\\\"eci\\\":36078631}]}\" ```

        :param cell_request: (required)
        :type cell_request: CellRequest
        :param do_reply:
        ...
        _param = self._get_location_from_cells_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CellResponseWithFulfillment",
        }
    ...
    @validate_call
    def get_location_from_cells_with_http_info(
        self,
        cell_request: CellRequest,
        do_reply: Optional[Any] = None,
        fallback: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CellResponseWithFulfillment]:
        """GetLocationFromCells
    ...
    @validate_call
    def get_location_from_cells_without_preload_content(
        self,
        cell_request: CellRequest,
        do_reply: Optional[Any] = None,
        fallback: Optional[StrictBool] = None,
    ...
    def _get_location_from_cells_serialize(
        self,
        cell_request,
        do_reply,
        fallback,
        ...
        if cell_request is not None:
            _body_params = cell_request
