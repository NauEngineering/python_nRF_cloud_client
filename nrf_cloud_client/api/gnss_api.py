...
class GNSSApi:
    ...
    def get_assistance_data(
        ...
        assistance_request: Optional[AssistanceRequest] = None,
        ...
        Provides assistance data to the device. Enables a faster time-to-first-fix (TTFF) for the GNSS modem. Returns the modem parameters for the nRF GNSS modem in a chunk. The chunk size is determined by the request Range header. See `GetAssistanceDataSize` [endpoint](#tag/GNSS/operation/GetAssistanceDataSize) for details.  __Basic Request__: ```sh curl -X POST \"$API_HOST/v1/location/agnss\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -H \"Accept: application/octet-stream\" -H \"Range: bytes=0-2200\" --output assistance.bin ```  __Custom Request__: ```sh curl -X POST \"$API_HOST/v1/location/agnss\" -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -H \"Accept: application/octet-stream\" -H \"Range: bytes=0-2200\" --output assistance.bin -d \"{\\\"types\\\": [8], \\\"mcc\\\": 244, \\\"mnc\\\": 91, \\\"tac\\\": 4099, \\\"eci\\\": 36078631}\" ``` __Type definitions__: - 1 = GPS UTC - 2 = GPS Ephemerides - 3 = GPS Almanac - 4 = Klobuchar Ionospheric Correction - 5 = Nequick Ionospheric Correction - 6 = GPS Time of Week - 7 = GPS System Clock - 8 = Location (lat/lon of cell) - 9 = GPS Integrity - 11 = QZSS Almanac - 12 = QZSS Ephemerides - 13 = QZSS Integrity

        :param range:
        :type range: str
        :param x_custom_device_id:
        :type x_custom_device_id: str
        :param assistance_request:
        :type assistance_request: AssistanceRequest
    ...
    def _get_assistance_data_serialize(
        ...
        if assistance_request is not None:
            _body_params = assistance_request
    ...
    @validate_call
    def get_assistance_data_size(
        self,
        types: Annotated[Optional[List[NrfMessageType]], Field(description="Type of assistance data (see description above). Defaults to [1, 2, 3, 4, 6, 7, 9]")] = None,
        ...
        _param = self._get_assistance_data_size_serialize(
            types=types,
            mcc=mcc,
            mnc=mnc,
            tac=tac,
    ...
    @validate_call
    def get_assistance_data_size_with_http_info(
        self,
        types: Annotated[Optional[List[NrfMessageType]], Field(description="Type of assistance data (see description above). Defaults to [1, 2, 3, 4, 6, 7, 9]")] = None,
        mcc: Optional[StrictInt] = None,
        mnc: Optional[Any] = None,
    ...
    @validate_call
    def get_assistance_data_size_without_preload_content(
        self,
        types: Annotated[Optional[List[NrfMessageType]], Field(description="Type of assistance data (see description above). Defaults to [1, 2, 3, 4, 6, 7, 9]")] = None,
        mcc: Optional[StrictInt] = None,
        mnc: Optional[Any] = None,
    ...
    def _get_assistance_data_size_serialize(
        self,
        types,
        mcc,
        mnc,
    ...
    @validate_call
    def get_predicted_assistance_data(
        self,
        prediction_count: Optional[Union[StrictFloat, StrictInt]] = None,
        prediction_interval_minutes: Optional[Union[StrictFloat, StrictInt]] = None,
        start_gps_day: Optional[Union[StrictFloat, StrictInt]] = None,
        start_gps_time_of_day_seconds: Optional[Union[StrictFloat, StrictInt]] = None,
        x_custom_device_id: Optional[Annotated[str, Field(strict=True)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Generates up to two weeks of GNSS predictions. The predictions are used by the nRF91 GNSS modem to enable a faster time-to-first-fix (TTFF) and provide offline navigation when out of range of an LTE cell.  Returns a link for easy download of the predictions file.  __Basic Request__: ```sh curl -G $API_HOST/v1/location/pgnss -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" ``` __Custom Request__: ```sh curl -G $API_HOST/v1/location/pgnss  -H \"Authorization: Bearer $JWT\" -H \"Content-Type: application/json\" -d \"predictionCount=42\" -d \"predictionIntervalMinutes=240\" -d \"startGpsDay=15131\" -d \"startGpsTimeOfDaySeconds=0\" ```

        :param prediction_count:
        :type prediction_count: float
        :param prediction_interval_minutes:
        :type prediction_interval_minutes: float
        :param start_gps_day:
        :type start_gps_day: float
        :param start_gps_time_of_day_seconds:
        :type start_gps_time_of_day_seconds: float
        :param x_custom_device_id:
        :type x_custom_device_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._get_predicted_assistance_data_serialize(
            prediction_count=prediction_count,
            prediction_interval_minutes=prediction_interval_minutes,
            start_gps_day=start_gps_day,
            start_gps_time_of_day_seconds=start_gps_time_of_day_seconds,
            x_custom_device_id=x_custom_device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetPredictedAssistanceData200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_predicted_assistance_data_with_http_info(
        self,
        prediction_count: Optional[Union[StrictFloat, StrictInt]] = None,
        prediction_interval_minutes: Optional[Union[StrictFloat, StrictInt]] = None,
        start_gps_day: Optional[Union[StrictFloat, StrictInt]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetPredictedAssistanceData200Response]:
        """GetPredictionData
    ...
    @validate_call
    def get_predicted_assistance_data_without_preload_content(
        self,
        prediction_count: Optional[Union[StrictFloat, StrictInt]] = None,
        prediction_interval_minutes: Optional[Union[StrictFloat, StrictInt]] = None,
        start_gps_day: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def _get_predicted_assistance_data_serialize(
        self,
        prediction_count,
        prediction_interval_minutes,
        start_gps_day,
        start_gps_time_of_day_seconds,
        x_custom_device_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        if prediction_count is not None:
            ...
            _query_params.append(('predictionCount', prediction_count))
            
        if prediction_interval_minutes is not None:
            
            _query_params.append(('predictionIntervalMinutes', prediction_interval_minutes))
            
        if start_gps_day is not None:
            
            _query_params.append(('startGpsDay', start_gps_day))
            
        if start_gps_time_of_day_seconds is not None:
            
            _query_params.append(('startGpsTimeOfDaySeconds', start_gps_time_of_day_seconds))
    ...
    @validate_call
    def record_gnss_coordinates(
        self,
        record_gnss_coordinates_request: RecordGnssCoordinatesRequest,
        x_custom_device_id: Optional[Annotated[str, Field(strict=True)]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Report device coordinates, commonly obtained from the device's GNSS modem.  __Basic Request__: ```sh curl --location --request POST \"$API_HOST/v1/location/gnss\" \\ --header \"Authorization: Bearer $JWT\" \\ --header \"Content-Type: application/json\" \\ --data-raw \"{\\\"lat\\\":$LAT, \\\"lon\\\":$LON, \\\"spd\\\":$SPD, \\\"acc\\\":$ACC, \\\"alt\\\":$ALT, \\\"hdg\\\":$HDG}\" ```

        :param record_gnss_coordinates_request: (required)
        :type record_gnss_coordinates_request: RecordGnssCoordinatesRequest
        :param x_custom_device_id:
        :type x_custom_device_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._record_gnss_coordinates_serialize(
            record_gnss_coordinates_request=record_gnss_coordinates_request,
            x_custom_device_id=x_custom_device_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def record_gnss_coordinates_with_http_info(
        self,
        record_gnss_coordinates_request: RecordGnssCoordinatesRequest,
        x_custom_device_id: Optional[Annotated[str, Field(strict=True)]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def record_gnss_coordinates_without_preload_content(
        self,
        record_gnss_coordinates_request: RecordGnssCoordinatesRequest,
        x_custom_device_id: Optional[Annotated[str, Field(strict=True)]] = None,
        _request_timeout: Union[
    ...
    def _record_gnss_coordinates_serialize(
        self,
        record_gnss_coordinates_request,
        x_custom_device_id,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if record_gnss_coordinates_request is not None:
            _body_params = record_gnss_coordinates_request
