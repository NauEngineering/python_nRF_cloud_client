...
class WiFiLocationApi:
    ...
    @validate_call
    def get_location_from_wifi_networks(
        self,
        wifi_access_points_request: WifiAccessPointsRequest,
        ...
        _param = self._get_location_from_wifi_networks_serialize(
            wifi_access_points_request=wifi_access_points_request,
            do_reply=do_reply,
            hi_conf=hi_conf,
            cont=cont,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PositionResponseWithExtras",
        }
    ...
    @validate_call
    def get_location_from_wifi_networks_with_http_info(
        self,
        wifi_access_points_request: WifiAccessPointsRequest,
        do_reply: Optional[Any] = None,
        hi_conf: Optional[StrictBool] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PositionResponseWithExtras]:
        """GetLocationFromWifiNetworks
    ...
    @validate_call
    def get_location_from_wifi_networks_without_preload_content(
        self,
        wifi_access_points_request: WifiAccessPointsRequest,
        do_reply: Optional[Any] = None,
        hi_conf: Optional[StrictBool] = None,
    ...
    def _get_location_from_wifi_networks_serialize(
        self,
        wifi_access_points_request,
        do_reply,
        hi_conf,
        cont,
        x_custom_device_id,
        ...
        if wifi_access_points_request is not None:
            _body_params = wifi_access_points_request
