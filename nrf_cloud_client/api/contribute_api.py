...
class ContributeApi:
    ...
    def contribute_location_data(
    ...
    ) -> ContributeLocationData200Response:
        """ContributeLocationData

        A contribution is the association of observed cell and Wi-Fi signals with a known geographic position. Contributions help improve the quality of location services and are available immediately in subsequent requests for the contributing team. More details coming soon on the <a href=\"https://docs.nordicsemi.com/bundle/nrf-cloud/page/LocationServices/Features.html\" target=\"_blank\">nRF Cloud Location Services Guide</a>.

        :param location_contribution: (required)
        :type location_contribution: LocationContribution
        ...
        _param = self._contribute_location_data_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ContributeLocationData200Response",
        }
    ...
    @validate_call
    def contribute_location_data_with_http_info(
        self,
        location_contribution: LocationContribution,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ContributeLocationData200Response]:
        """ContributeLocationData
    ...
    @validate_call
    def contribute_location_data_without_preload_content(
        self,
        location_contribution: LocationContribution,
        _request_timeout: Union[
            None,
    ...
    def _contribute_location_data_serialize(
        self,
        ...
        if location_contribution is not None:
            _body_params = location_contribution
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/location/contribute',
    ...
    def delete_contribution(
        ...
        _param = self._delete_contribution_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_contribution_with_http_info(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_contribution_without_preload_content(
        self,
        id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _delete_contribution_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/location/contribute/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_contributions(
        ...
        _param = self._get_contributions_serialize(
            page_sort=page_sort,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedResultContributionItem",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def get_contributions_with_http_info(
        self,
        page_sort: Optional[PageSort] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultContributionItem]:
        """GetContributions
    ...
    @validate_call
    def get_contributions_without_preload_content(
        self,
        page_sort: Optional[PageSort] = None,
        page_limit: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        page_next_token: Optional[StrictStr] = None,
    ...
    def _get_contributions_serialize(
        self,
        page_sort,
        page_limit,
        page_next_token,
