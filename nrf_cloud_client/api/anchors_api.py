...
class AnchorsApi:
    ...
    def create_anchor(
        ...
        :param anchor_input: (required)
        :type anchor_input: AnchorInput
        ...
        _param = self._create_anchor_serialize(
    ...
    @validate_call
    def create_anchor_with_http_info(
        self,
        anchor_input: AnchorInput,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_anchor_without_preload_content(
        self,
        anchor_input: AnchorInput,
        _request_timeout: Union[
            None,
    ...
    def _create_anchor_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/location/anchors',
    ...
    def delete_anchor(
        ...
        _param = self._delete_anchor_serialize(
    ...
    @validate_call
    def delete_anchor_with_http_info(
        self,
        mac_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_anchor_without_preload_content(
        self,
        mac_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_anchor_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/location/anchors/{macAddress}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_anchor(
        ...
        _param = self._fetch_anchor_serialize(
            mac_address=mac_address,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_anchor_with_http_info(
        self,
        mac_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_anchor_without_preload_content(
        self,
        mac_address: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def list_anchors(
        ...
        _param = self._list_anchors_serialize(
    ...
    @validate_call
    def list_anchors_with_http_info(
        self,
        page_next_token: Optional[StrictStr] = None,
        page_limit: Optional[Union[StrictFloat, StrictInt]] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedResultAnchor]:
        """ListAnchors
    ...
    @validate_call
    def list_anchors_without_preload_content(
        self,
        page_next_token: Optional[StrictStr] = None,
        page_limit: Optional[Union[StrictFloat, StrictInt]] = None,
        _request_timeout: Union[
    ...
    def update_anchor(
        self,
        mac_address: StrictStr,
        anchor_update_input: AnchorUpdateInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param mac_address: (required)
        :type mac_address: str
        :param anchor_update_input: (required)
        :type anchor_update_input: AnchorUpdateInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_anchor_serialize(
            mac_address=mac_address,
            anchor_update_input=anchor_update_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_anchor_with_http_info(
        self,
        mac_address: StrictStr,
        anchor_update_input: AnchorUpdateInput,
        _request_timeout: Union[
    ...
    @validate_call
    def update_anchor_without_preload_content(
        self,
        mac_address: StrictStr,
        anchor_update_input: AnchorUpdateInput,
        _request_timeout: Union[
    ...
    def _update_anchor_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if anchor_update_input is not None:
            _body_params = anchor_update_input
