...
class BluetoothLowEnergyDevicesApi:
    ...
    def add_peripheral(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        ...
        """(Deprecated) AddPeripheral

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">Support for Bluetooth Low Energy devices will be removed soon.</div>  Initiate connection of a peripheral to a gateway by adding to the gateway's `desired.desiredConnections` array the peripheral id.

        :param gateway_id: (required)
        :type gateway_id: str
        :param peripheral_id: (required)
        ...
        """ # noqa: E501
        warnings.warn("PUT /devices/{gatewayId}/{peripheralId} is deprecated.", DeprecationWarning)

        _param = self._add_peripheral_serialize(
    ...
    @validate_call
    def add_peripheral_with_http_info(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    @validate_call
    def add_peripheral_without_preload_content(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    def _add_peripheral_serialize(
        ...
        if peripheral_id is not None:
            _path_params['peripheralId'] = peripheral_id
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/devices/{gatewayId}/{peripheralId}',
    ...
    @validate_call
    def fetch_characteristic_descriptor_value(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """(Deprecated) FetchDescriptorValue

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">Support for Bluetooth Low Energy devices will be removed soon.</div>  Fetch the latest characteristic descriptor value that is cached as part of the device state in our database. It may not fetch the latest characteristic descriptor value that is on the device (which can take a quite long to retrieve directly via a REST). Therefore, this value can be stale. If you want the latest it is best to first call the `StartPeripheralDiscovery` [endpoint](#operation/StartPeripheralDiscovery) to force a rediscovery of the BLE device state.

        :param device_id: (required)
        :type device_id: str
        :param characteristic_id: (required)
        :type characteristic_id: str
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /devices/{deviceId}/characteristics/{characteristicId}/descriptors/{descriptorId} is deprecated.", DeprecationWarning)

        _param = self._fetch_characteristic_descriptor_value_serialize(
            device_id=device_id,
    ...
    @validate_call
    def fetch_characteristic_descriptor_value_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
    ...
    @validate_call
    def fetch_characteristic_descriptor_value_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
    ...
    def _fetch_characteristic_descriptor_value_serialize(
        self,
        device_id,
        characteristic_id,
        descriptor_id,
        ...
        if characteristic_id is not None:
            _path_params['characteristicId'] = characteristic_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/devices/{deviceId}/characteristics/{characteristicId}/descriptors/{descriptorId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_characteristic_value(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        _request_timeout: Union[
        ...
        """(Deprecated) FetchCharacteristicValue

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">Support for Bluetooth Low Energy devices will be removed soon.</div>  Fetch the latest characteristic value that is cached as part of the device state in our database. It may not fetch the latest characteristic value that is on the device (which can take a quite long to retrieve directly via a REST). Therefore, this value can be stale. If you want the latest it is best to first call the `StartPeripheralDiscovery` [endpoint](#operation/StartPeripheralDiscovery) to force a rediscovery of the BLE device state.
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /devices/{deviceId}/characteristics/{characteristicId} is deprecated.", DeprecationWarning)

        _param = self._fetch_characteristic_value_serialize(
            device_id=device_id,
            characteristic_id=characteristic_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def fetch_characteristic_value_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_characteristic_value_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        _request_timeout: Union[
    ...
    def _fetch_characteristic_value_serialize(
        self,
        device_id,
        characteristic_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/devices/{deviceId}/characteristics/{characteristicId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def start_peripheral_discovery(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
        ...
        """(Deprecated) StartPeripheralDiscovery

        <div style=\"background-color: #f8d7da; color: #721c24; text-align: center; border: 1px solid #f5c6cb; border-radius: .25rem; padding: .75rem 1.25rem\">Support for Bluetooth Low Energy devices will be removed soon.</div>  Initiate a discovery process for a BLE device. When discovery is complete (30-60 seconds), results will be stored in our database and retrievable for the device via the `FetchDevice` [endpoint](#operation/FetchDevice).
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("POST /devices/{gatewayId}/discover/{peripheralId} is deprecated.", DeprecationWarning)

        _param = self._start_peripheral_discovery_serialize(
            gateway_id=gateway_id,
            peripheral_id=peripheral_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def start_peripheral_discovery_with_http_info(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    @validate_call
    def start_peripheral_discovery_without_preload_content(
        self,
        gateway_id: Annotated[str, Field(strict=True)],
        peripheral_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
    ...
    def _start_peripheral_discovery_serialize(
        self,
        gateway_id,
        peripheral_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/devices/{gatewayId}/discover/{peripheralId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_characteristic_descriptor_value(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
        request_body: List[Union[StrictFloat, StrictInt]],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """(Deprecated) UpdateDescriptorValue
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /devices/{deviceId}/characteristics/{characteristicId}/descriptors/{descriptorId} is deprecated.", DeprecationWarning)

        _param = self._update_characteristic_descriptor_value_serialize(
            device_id=device_id,
            characteristic_id=characteristic_id,
            descriptor_id=descriptor_id,
    ...
    @validate_call
    def update_characteristic_descriptor_value_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
    ...
    @validate_call
    def update_characteristic_descriptor_value_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        descriptor_id: StrictStr,
    ...
    def _update_characteristic_descriptor_value_serialize(
        self,
        device_id,
        characteristic_id,
        descriptor_id,
    ...
    def update_characteristic_value(
        ...
        """(Deprecated) UpdateCharacteristicValue
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /devices/{deviceId}/characteristics/{characteristicId} is deprecated.", DeprecationWarning)

        _param = self._update_characteristic_value_serialize(
            device_id=device_id,
            characteristic_id=characteristic_id,
            request_body=request_body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_characteristic_value_with_http_info(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        request_body: List[Union[StrictFloat, StrictInt]],
    ...
    @validate_call
    def update_characteristic_value_without_preload_content(
        self,
        device_id: Annotated[str, Field(strict=True)],
        characteristic_id: StrictStr,
        request_body: List[Union[StrictFloat, StrictInt]],
    ...
    def _update_characteristic_value_serialize(
        self,
        device_id,
        characteristic_id,
        request_body,
