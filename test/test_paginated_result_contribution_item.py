...
class TestPaginatedResultContributionItem(unittest.TestCase):
    """PaginatedResultContributionItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultContributionItem:
        """Test PaginatedResultContributionItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultContributionItem`
        """
        model = PaginatedResultContributionItem()
        if include_optional:
            return PaginatedResultContributionItem(
                items = [
                    nrf_cloud_client.models.contribution_item.ContributionItem(
                        id = 'bc631093-7f7c-4c1b-aa63-a68c759bcd5c', 
                        contributions = [
                            nrf_cloud_client.models.contribution.Contribution(
                                cell = [
                                    nrf_cloud_client.models.cell_observation.CellObservation(
                                        cell = nrf_cloud_client.models.lte_cell.LteCell(
                                            rsrp = -90, 
                                            rsrq = -8, 
                                            mcc = 310, 
                                            mnc = 120, 
                                            ...
                                            adv = 20000, 
                                            nmr = [
                                                nrf_cloud_client.models.lte_neighbor_measurement.LteNeighborMeasurement(
                                                    rsrp = -90, 
                                                    rsrq = -8, 
                                                    earfcn = 41490, 
                                                    pci = 143, 
                                        ...
                                        cell_type = 'LTE', 
                                        observed_at = '2021-03-07T21:02:51.907Z', )
                                    ], 
                                wifi = [
                                    null
                                    ], )
                            ], 
                        device = nrf_cloud_client.models.observing_device.ObservingDevice(
                            manufacturer = '', 
                            firmware_version = '', 
                            modem_version = '', 
                            id = '', ), 
                        position = nrf_cloud_client.models.position_response.PositionResponse(
                            lat = 45.524098, 
                            lon = -122.688408, 
                            uncertainty = 300, ), 
                        created_at = '1993-12-25T21:05:12.830Z', )
                    ],
                total = 10,
                page_next_token = '4bb1f9ab35bd'
            )
        else:
            return PaginatedResultContributionItem(
                items = [
    ...
    def testPaginatedResultContributionItem(self):
        """Test PaginatedResultContributionItem"""
