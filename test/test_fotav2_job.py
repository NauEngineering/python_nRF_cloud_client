...
class TestFOTAV2Job(unittest.TestCase):
    """FOTAV2Job unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FOTAV2Job:
        """Test FOTAV2Job
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FOTAV2Job`
        """
        model = FOTAV2Job()
        if include_optional:
            return FOTAV2Job(
                job_id = 'bc631093-7f7c-4c1b-aa63-a68c759bcd5c',
                target = nrf_cloud_client.models.fota_v2_job_target_model.FotaV2JobTargetModel(
                    device_ids = [
