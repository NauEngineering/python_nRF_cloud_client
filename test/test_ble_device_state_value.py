...
class TestBLEDeviceStateValue(unittest.TestCase):
    """BLEDeviceStateValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BLEDeviceStateValue:
        """Test BLEDeviceStateValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BLEDeviceStateValue`
        """
        model = BLEDeviceStateValue()
        if include_optional:
            return BLEDeviceStateValue(
                characteristics = {
                    'key' : nrf_cloud_client.models.characteristics_value.Characteristics_value(
                        descriptors = {
                            'key' : nrf_cloud_client.models.descriptors_value.Descriptors_value(
                                value = [
                                    1.337
                                    ], 
                                path = '', 
                        ...
                        properties = nrf_cloud_client.models.characteristics_value_properties.Characteristics_value_properties(
                            broadcast = True, 
                            authorized_signed_write = True, 
                            indicate = True, 
                            notify = True, 
                            write = True, 
    ...
    def testBLEDeviceStateValue(self):
        """Test BLEDeviceStateValue"""
