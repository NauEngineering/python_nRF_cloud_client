...
class TestGetLocationFromCellsOrWifiNetworksRequest(unittest.TestCase):
    """GetLocationFromCellsOrWifiNetworksRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLocationFromCellsOrWifiNetworksRequest:
        """Test GetLocationFromCellsOrWifiNetworksRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLocationFromCellsOrWifiNetworksRequest`
        """
        model = GetLocationFromCellsOrWifiNetworksRequest()
        if include_optional:
            return GetLocationFromCellsOrWifiNetworksRequest(
                lte = [
                    nrf_cloud_client.models.lte_cell.LteCell(
                        rsrp = -90, 
                        rsrq = -8, 
                        mcc = 310, 
                        mnc = 120, 
                ...
                wifi = nrf_cloud_client.models.wifi_access_points_request.WifiAccessPointsRequest(
                    access_points = [
                        null
                        ], )
            )
    ...
    def testGetLocationFromCellsOrWifiNetworksRequest(self):
        """Test GetLocationFromCellsOrWifiNetworksRequest"""
