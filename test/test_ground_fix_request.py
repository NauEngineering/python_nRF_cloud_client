...
class TestGroundFixRequest(unittest.TestCase):
    """GroundFixRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroundFixRequest:
        """Test GroundFixRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroundFixRequest`
        """
        model = GroundFixRequest()
        if include_optional:
            return GroundFixRequest(
                lte = [
