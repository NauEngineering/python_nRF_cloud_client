...
class TestFotaJobV2Plus(unittest.TestCase):
    """FotaJobV2Plus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FotaJobV2Plus:
        """Test FotaJobV2Plus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FotaJobV2Plus`
        """
        model = FotaJobV2Plus()
        if include_optional:
            return FotaJobV2Plus(
