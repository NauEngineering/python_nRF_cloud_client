...
class TestLocationContribution(unittest.TestCase):
    """LocationContribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocationContribution:
        """Test LocationContribution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocationContribution`
        """
        model = LocationContribution()
        if include_optional:
            return LocationContribution(
    ...
    def testLocationContribution(self):
        """Test LocationContribution"""
