...
class TestIPDevicesApi(unittest.TestCase):
    """IPDevicesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = IPDevicesApi()

    def tearDown(self) -> None:
        pass

    def test_associate_device(self) -> None:
        """Test case for associate_device

        AssociateDevice
        """
        pass

    def test_create_device_certificate(self) -> None:
        """Test case for create_device_certificate

        CreateDeviceCertificate
        """
        pass

    def test_dissociate_device(self) -> None:
        """Test case for dissociate_device

        DissociateDevice
        """
        pass

    def test_onboard_device(self) -> None:
        """Test case for onboard_device

        OnboardDevice
        """
        pass

    def test_onboard_devices(self) -> None:
    ...
    def test_register_certificates(self) -> None:
        """Test case for register_certificates

        RegisterCertificates
        """
        pass

    def test_register_public_keys(self) -> None:
        """Test case for register_public_keys
