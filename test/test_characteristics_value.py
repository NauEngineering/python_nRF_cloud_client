...
class TestCharacteristicsValue(unittest.TestCase):
    """CharacteristicsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CharacteristicsValue:
        """Test CharacteristicsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CharacteristicsValue`
        """
    ...
    def testCharacteristicsValue(self):
        """Test CharacteristicsValue"""
