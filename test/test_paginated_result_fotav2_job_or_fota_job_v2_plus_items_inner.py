...
class TestPaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner(unittest.TestCase):
    """PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner:
        """Test PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner`
        """
        model = PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner()
        if include_optional:
            return PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner(
                job_id = 'bc631093-7f7c-4c1b-aa63-a68c759bcd5c',
                target = nrf_cloud_client.models.fota_job_v2_plus_target.FotaJobV2Plus_target(
                    firmware_versions = [
                        ''
                        ], 
                    firmware_type = 'APP', 
                ...
                name = '',
                execution_stats = nrf_cloud_client.models.fotav2_job_execution_stats.FOTAV2Job_executionStats(
                    completed_executions = 1.337, 
                    executions = 1.337, 
                    devices = 1.337, 
                    timed_out = 1.337, 
                    removed = 1.337, 
                    ...
                    succeeded = 1.337, 
                    cancelled = 1.337, ),
                firmware = nrf_cloud_client.models.fotav2_job_firmware.FOTAV2Job_firmware(
                    bundle_id = null, 
                    host = '', 
                    file_size = 1.337, 
                    firmware_type = 'APP', 
                ...
                schedule = nrf_cloud_client.models.job_schedule.JobSchedule(
                    start_job_at_epoch_ms = 1.337, 
                    lock_target_list_at_epoch_ms = 1.337, ),
                target_list_type = 'LOCKED'
            )
        else:
            return PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner(
                job_id = 'bc631093-7f7c-4c1b-aa63-a68c759bcd5c',
    ...
    def testPaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner(self):
        """Test PaginatedResultFOTAV2JobOrFotaJobV2PlusItemsInner"""
